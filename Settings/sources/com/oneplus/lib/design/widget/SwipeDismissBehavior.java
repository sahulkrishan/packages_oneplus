...
import com.oneplus.lib.util.ViewDragHelper;
import com.oneplus.lib.util.ViewDragHelper.Callback;
    ...
    private final Callback mDragCallback = new Callback() {
        ...
        public void onViewReleased(View child, float xvel, float yvel) {
            ...
            if (shouldDismiss(child, xvel)) {
                if (child.getLeft() < this.mOriginalCapturedViewLeft) {
                    targetLeft = this.mOriginalCapturedViewLeft - childWidth;
                } else {
                    targetLeft = this.mOriginalCapturedViewLeft + childWidth;
                }
                dismiss = true;
