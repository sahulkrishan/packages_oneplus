...
import com.oneplus.lib.design.widget.BaseTransientBottomBar.BaseCallback;
...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence text, int duration) {
        ...
        if (parent != null) {
            SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(R.layout.op_design_layout_snackbar_include, parent, false);
