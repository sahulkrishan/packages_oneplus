...
public class ViewUtilsLollipop {
    ...
    public static void setDefaultAppBarLayoutStateListAnimator(View view, float elevation) {
        ...
        sla.addState(new int[]{16842766, R.attr.op_state_collapsible, -R.attr.op_state_collapsed}, ObjectAnimator.ofFloat(view, "elevation", new float[]{0.0f}).setDuration((long) dur));
