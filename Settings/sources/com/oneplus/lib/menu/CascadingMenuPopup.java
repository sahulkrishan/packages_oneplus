...
public class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    public CascadingMenuPopup(Context context, View anchor, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(R.dimen.op_abc_config_prefDialogWidth));
    ...
    private void showMenu(MenuBuilder menu) {
        ...
        if (parentView != null) {
            ...
            if (SystemUtils.isAtLeastO()) {
                ...
                int parentOffsetLeft2 = parentViewScreenLocation[0] - anchorScreenLocation[0];
                parentOffsetTop = parentViewScreenLocation[1] - anchorScreenLocation[1];
                parentOffsetLeft = parentOffsetLeft2;
            }
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) inflater.inflate(R.layout.op_abc_popup_menu_header_item_layout, listView, false);
