...
import com.oneplus.lib.menu.ActionMenuItemView.PopupCallback;
import com.oneplus.lib.menu.ActionMenuView.ActionMenuChildView;
...
import com.oneplus.lib.widget.ActionProvider.SubUiVisibilityListener;
import com.oneplus.lib.widget.ForwardingListener;
import com.oneplus.lib.widget.actionbar.ActionBarPolicy;
...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class OverflowMenuButton extends ImageView implements ActionMenuChildView {
    ...
    public ActionMenuPresenter(Context context) {
        super(context, R.layout.op_abc_action_menu_layout, R.layout.op_abc_action_menu_item_layout);
    }
    ...
    public void initForMenu(Context context, MenuBuilder menu) {
        ...
        this.mMinCellSize = (int) (48.0f * res.getDisplayMetrics().density);
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenu) {
        ...
        this.mActionButtonPopup.setGravity(GravityCompat.END);
        this.mActionButtonPopup.showSubMenu();
    ...
    L_0x0028:
        r13 = r1.get(r4);
        r13 = (com.oneplus.lib.menu.MenuItemImpl) r13;
    ...
    L_0x0078:
        r16 = r1.get(r2);
        r15 = r16;
        r15 = (com.oneplus.lib.menu.MenuItemImpl) r15;
    ...
    L_0x009a:
        r8 = 0;
        r16 = com.oneplus.lib.menu.ActionMenuView.measureChildForCells(r3, r13, r14, r6, r8);
        r14 = r14 - r16;
        goto L_0x00a5;
    L_0x00a2:
        r3.measure(r6, r6);
    ...
    L_0x010d:
        r7 = 0;
        r16 = com.oneplus.lib.menu.ActionMenuView.measureChildForCells(r9, r13, r14, r6, r7);
        r14 = r14 - r16;
    ...
    L_0x015c:
        r9 = r1.get(r7);
        r9 = (com.oneplus.lib.menu.MenuItemImpl) r9;
        r0 = r9.getGroupId();
    ...
    L_0x019c:
        ...
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.menu.ActionMenuPresenter.flagActionItems():boolean");
    }
