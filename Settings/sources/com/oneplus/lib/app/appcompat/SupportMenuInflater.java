...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, R.styleable.OPMenuGroup);
            this.groupId = a.getResourceId(R.styleable.OPMenuGroup_android_id, 0);
            this.groupCategory = a.getInt(R.styleable.OPMenuGroup_android_menuCategory, 0);
            this.groupOrder = a.getInt(R.styleable.OPMenuGroup_android_orderInCategory, 0);
            this.groupCheckable = a.getInt(R.styleable.OPMenuGroup_android_checkableBehavior, 0);
            this.groupVisible = a.getBoolean(R.styleable.OPMenuGroup_android_visible, true);
            this.groupEnabled = a.getBoolean(R.styleable.OPMenuGroup_android_enabled, true);
            a.recycle();
        }

        public void readItem(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, R.styleable.OPMenuItem);
            this.itemId = a.getResourceId(R.styleable.OPMenuItem_android_id, 0);
            this.itemCategoryOrder = (-65536 & a.getInt(R.styleable.OPMenuItem_android_menuCategory, this.groupCategory)) | (65535 & a.getInt(R.styleable.OPMenuItem_android_orderInCategory, this.groupOrder));
            this.itemTitle = a.getText(R.styleable.OPMenuItem_android_title);
            this.itemTitleCondensed = a.getText(R.styleable.OPMenuItem_android_titleCondensed);
            this.itemIconResId = a.getResourceId(R.styleable.OPMenuItem_android_icon, 0);
            this.itemAlphabeticShortcut = getShortcut(a.getString(R.styleable.OPMenuItem_android_alphabeticShortcut));
            this.itemNumericShortcut = getShortcut(a.getString(R.styleable.OPMenuItem_android_numericShortcut));
            if (a.hasValue(R.styleable.OPMenuItem_android_checkable)) {
                this.itemCheckable = a.getBoolean(R.styleable.OPMenuItem_android_checkable, false);
            } else {
                this.itemCheckable = this.groupCheckable;
            }
            this.itemChecked = a.getBoolean(R.styleable.OPMenuItem_android_checked, false);
            this.itemVisible = a.getBoolean(R.styleable.OPMenuItem_android_visible, this.groupVisible);
            this.itemEnabled = a.getBoolean(R.styleable.OPMenuItem_android_enabled, this.groupEnabled);
            this.itemShowAsAction = a.getInt(R.styleable.OPMenuItem_android_showAsAction, -1);
            this.itemListenerMethodName = a.getString(R.styleable.OPMenuItem_android_onClick);
            this.itemActionViewLayout = a.getResourceId(R.styleable.OPMenuItem_actionLayout, 0);
            this.itemActionViewClassName = a.getString(R.styleable.OPMenuItem_actionViewClass);
            this.itemActionProviderClassName = a.getString(R.styleable.OPMenuItem_actionProviderClass);
