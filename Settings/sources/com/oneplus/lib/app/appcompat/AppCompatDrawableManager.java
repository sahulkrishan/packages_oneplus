...
public class AppCompatDrawableManager {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:36:0x00a1 A:{Catch:{ Exception -> 0x00a9 }} */
    /* JADX WARNING: Removed duplicated region for block: B:30:0x007c A:{Catch:{ Exception -> 0x00a9 }} */
    private android.graphics.drawable.Drawable loadDrawableFromDelegates(@android.support.annotation.NonNull android.content.Context r12, int r13) {
        /*
        r11 = this;
        r0 = r11.mDelegates;
        r1 = 0;
    ...
    L_0x0059:
        ...
        if (r6 == 0) goto L_0x00aa;
    L_0x0067:
        r6 = r1.getXml(r13);	 Catch:{ Exception -> 0x00a9 }
        r7 = android.util.Xml.asAttributeSet(r6);	 Catch:{ Exception -> 0x00a9 }
    L_0x006f:
        r8 = r6.next();	 Catch:{ Exception -> 0x00a9 }
        r9 = r8;
        r10 = 2;
    ...
    L_0x007c:
        r2 = r6.getName();	 Catch:{ Exception -> 0x00a9 }
        r8 = r11.mKnownDrawableIdTags;	 Catch:{ Exception -> 0x00a9 }
        r8.append(r13, r2);	 Catch:{ Exception -> 0x00a9 }
        r8 = r11.mDelegates;	 Catch:{ Exception -> 0x00a9 }
        r8 = r8.get(r2);	 Catch:{ Exception -> 0x00a9 }
        r8 = (com.oneplus.lib.app.appcompat.AppCompatDrawableManager.InflateDelegate) r8;	 Catch:{ Exception -> 0x00a9 }
        if (r8 == 0) goto L_0x0099;
        r10 = r12.getTheme();	 Catch:{ Exception -> 0x00a9 }
        r10 = r8.createFromXmlInner(r12, r6, r7, r10);	 Catch:{ Exception -> 0x00a9 }
        r5 = r10;
    L_0x0099:
        if (r5 == 0) goto L_0x00a0;
    L_0x009b:
        r10 = r0.changingConfigurations;	 Catch:{ Exception -> 0x00a9 }
        r5.setChangingConfigurations(r10);	 Catch:{ Exception -> 0x00a9 }
    L_0x00a0:
        goto L_0x00aa;
    L_0x00a1:
        r2 = new org.xmlpull.v1.XmlPullParserException;	 Catch:{ Exception -> 0x00a9 }
        r8 = "No start tag found";
        r2.<init>(r8);	 Catch:{ Exception -> 0x00a9 }
    ...
    public ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId, @Nullable ColorStateList customTint) {
        ...
        if (tint == null) {
            if (resId == R.drawable.abc_edit_text_material) {
                ...
                tint = AppCompatResources.getColorStateList(context, R.color.op_abc_tint_switch_thumb);
    ...
    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int baseColor, @Nullable ColorStateList tint) {
        ...
        colors[0] = tint == null ? disabledColor : tint.getColorForState(states[0], 0);
        int i2 = 0 + 1;
        ...
        colors[i2] = tint == null ? baseColor : tint.getColorForState(states[i2], 0);
        i2++;
