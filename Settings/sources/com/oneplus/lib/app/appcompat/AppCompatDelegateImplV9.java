...
import com.oneplus.lib.app.appcompat.ContentFrameLayout.OnAttachListener;
import com.oneplus.lib.app.appcompat.FitWindowsViewGroup.OnFitSystemWindowsListener;
import com.oneplus.lib.menu.ListMenuPresenter;
...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    ViewPropertyAnimator mFadeAnim = null;
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            protected SavedState(Parcel in) {
                ...
                this.isOpen = in.readByte() != (byte) 0;
        ...
        public void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(16843920, outValue, true);
            if (outValue.resourceId != 0) {
                this.elevation = context.getResources().getDimension(outValue.resourceId);
            }
        ...
        public MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, R.layout.op_abc_list_menu_item_layout);
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim = AppCompatDelegateImplV9.this.mActionModeView.animate().alpha(0.0f);
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new AnimatorListener() {
    ...
    public void setSupportActionBar(Toolbar toolbar) {
        if (this.mOriginalWindowCallback instanceof Activity) {
            if (this.mContentFrameLayout != null) {
                this.mContentFrameLayout.setSupportToolbar(toolbar);
        ...
        if (a.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (this.mOverlayActionMode) {
                    subDecor2 = (ViewGroup) inflater.inflate(R.layout.op_abc_screen_simple_overlay_action_mode, null);
                } else {
                    subDecor2 = (ViewGroup) inflater.inflate(R.layout.op_abc_screen_simple, null);
                }
                subDecor = subDecor2;
                this.mContentFrameLayout = (ContentFrameLayout) subDecor.findViewById(R.id.action_bar_activity_content);
                if (this.mContentFrameLayout != null) {
                    this.mDecorContentParent = this.mContentFrameLayout;
                    this.mDecorContentParent.setWindowCallback(getWindowCallback());
                }
                if (VERSION.SDK_INT >= 21) {
                    subDecor.setOnApplyWindowInsetsListener(new OnApplyWindowInsetsListener() {
                ...
                subDecor = (ViewGroup) inflater.inflate(R.layout.op_abc_dialog_title_material, null);
                ...
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(R.layout.op_abc_screen_toolbar, null);
                    ...
                    this.mShowActionModePopup = new Runnable() {
                        public void run() {
                            ...
                            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                                ...
                                AppCompatDelegateImplV9.this.mFadeAnim = AppCompatDelegateImplV9.this.mActionModeView.animate().alpha(1.0f);
                                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new AnimatorListener() {
                                    public void onAnimationStart(Animator animator) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim = this.mActionModeView.animate().alpha(1.0f);
                        this.mFadeAnim.setListener(new AnimatorListener() {
                            public void onAnimationStart(Animator animator) {
                                AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    private boolean initializePanelDecor(PanelFeatureState st) {
        ...
        if (st.elevation != 0.0f) {
            st.decorView.setElevation(st.elevation);
        }
        st.gravity = 81;
        return true;
    }
