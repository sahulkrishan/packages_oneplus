...
public class Toolbar extends android.widget.Toolbar {
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setPopupTheme(a.getResourceId(R.styleable.Toolbar_android_popupTheme, 0));
        ...
        if (a.hasValue(R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(R.styleable.Toolbar_subtitleTextColor, contentInsetEnd));
        }
        a.recycle();
        this.mNeedResetPadding = getFitsSystemWindows() ^ 1;
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int measuredWidth = resolveSizeAndState(Math.max((width + height) + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i7, ViewCompat.MEASURED_STATE_MASK & navWidth);
        ...
        setMeasuredDimension(measuredWidth, shouldCollapse() ? i2 : measuredHeight);
    }
    ...
    /* JADX WARNING: Missing block: B:52:0x016c, code skipped:
            if (r0.mTitleTextView.getMeasuredWidth() <= 0) goto L_0x0171;
     */
    ...
    L_0x000d:
        ...
        r9 = r45.getWidth();
        r10 = r45.getHeight();
        r11 = r0.mNeedResetPadding;
        if (r11 == 0) goto L_0x0033;
    L_0x0031:
        r0.mNeedResetPadding = r3;
    L_0x0033:
