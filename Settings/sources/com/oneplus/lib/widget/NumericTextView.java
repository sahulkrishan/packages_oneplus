...
public class NumericTextView extends TextView {
    ...
    private void updateMinimumWidth() {
        ...
        for (int i = 0; i < this.mMaxValue; i++) {
            ...
            setText(String.format(stringBuilder.toString(), new Object[]{Integer.valueOf(i)}));
            measure(0, 0);
    ...
    private boolean handleKeyUp(int keyCode) {
        ...
        if (this.mCount > 0) {
            ...
            stringBuilder.append("d");
            formattedValue = String.format(stringBuilder.toString(), new Object[]{Integer.valueOf(this.mValue)});
        } else {
            formattedValue = "";
        }
