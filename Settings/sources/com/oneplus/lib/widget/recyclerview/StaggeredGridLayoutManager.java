...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    public void updateMeasureSpecs() {
        ...
        this.mFullSizeSpec = MeasureSpec.makeMeasureSpec(this.mSecondaryOrientation.getTotalSpace(), Ints.MAX_POWER_OF_TWO);
        if (this.mOrientation == 1) {
            this.mWidthSpec = MeasureSpec.makeMeasureSpec(this.mSizePerSpan, Ints.MAX_POWER_OF_TWO);
            this.mHeightSpec = MeasureSpec.makeMeasureSpec(0, 0);
            return;
        }
        this.mHeightSpec = MeasureSpec.makeMeasureSpec(this.mSizePerSpan, Ints.MAX_POWER_OF_TWO);
    ...
    private int computeScrollOffset(State state) {
        ...
        ensureOrientationHelper();
        return ScrollbarHelper.computeScrollOffset(state, this.mPrimaryOrientation, findFirstVisibleItemClosestToStart(this.mSmoothScrollbarEnabled ^ 1, true), findFirstVisibleItemClosestToEnd(this.mSmoothScrollbarEnabled ^ 1, true), this, this.mSmoothScrollbarEnabled, this.mShouldReverseLayout);
    }
    ...
    private int computeScrollExtent(State state) {
        ...
        ensureOrientationHelper();
        return ScrollbarHelper.computeScrollExtent(state, this.mPrimaryOrientation, findFirstVisibleItemClosestToStart(this.mSmoothScrollbarEnabled ^ 1, true), findFirstVisibleItemClosestToEnd(this.mSmoothScrollbarEnabled ^ 1, true), this, this.mSmoothScrollbarEnabled);
    }
    ...
    private int computeScrollRange(State state) {
        ...
        ensureOrientationHelper();
        return ScrollbarHelper.computeScrollRange(state, this.mPrimaryOrientation, findFirstVisibleItemClosestToStart(this.mSmoothScrollbarEnabled ^ 1, true), findFirstVisibleItemClosestToEnd(this.mSmoothScrollbarEnabled ^ 1, true), this, this.mSmoothScrollbarEnabled);
    }
    ...
    private int getSpecForDimension(int dim, int defaultSpec) {
        ...
        return MeasureSpec.makeMeasureSpec(dim, Ints.MAX_POWER_OF_TWO);
    }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View host, AccessibilityNodeInfo info) {
        ...
        if (lp instanceof LayoutParams) {
            ...
            if (this.mOrientation == 0) {
                ...
                info.setCollectionItemInfo(CollectionItemInfo.obtain(spanIndex, i, -1, -1, sglp.mFullSpan, false));
            } else {
                ...
                int i2 = i;
                info.setCollectionItemInfo(CollectionItemInfo.obtain(-1, -1, spanIndex2, i2, sglp.mFullSpan, false));
            }
            return;
        }
    ...
    private int fill(com.oneplus.lib.widget.recyclerview.RecyclerView.Recycler r24, com.oneplus.lib.widget.recyclerview.LayoutState r25, com.oneplus.lib.widget.recyclerview.RecyclerView.State r26) {
        /*
        r23 = this;
        r6 = r23;
        r7 = r24;
    ...
    L_0x0047:
        ...
        r15 = r0;
        r15 = (com.oneplus.lib.widget.recyclerview.StaggeredGridLayoutManager.LayoutParams) r15;
    ...
    L_0x01bc:
        return r17;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.widget.recyclerview.StaggeredGridLayoutManager.fill(com.oneplus.lib.widget.recyclerview.RecyclerView$Recycler, com.oneplus.lib.widget.recyclerview.LayoutState, com.oneplus.lib.widget.recyclerview.RecyclerView$State):int");
    }
