...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    private int mPaddingLeftInActionBar;
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (widthDp >= ConfigureWifiSettings.WIFI_WAKEUP_REQUEST_CODE || (widthDp >= 640 && heightDp >= 480)) {
                return 192;
            }
            return 160;
        }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(a.getResourceId(R.styleable.SearchView_android_layout, R.layout.op_search_view), this, true);
        ...
        this.mSearchPlate.setBackground(a.getDrawable(R.styleable.SearchView_android_queryBackground));
        this.mSubmitArea.setBackground(a.getDrawable(R.styleable.SearchView_android_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(R.styleable.SearchView_android_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(R.styleable.SearchView_android_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(R.styleable.SearchView_android_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(R.styleable.SearchView_android_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(R.styleable.SearchView_android_searchIcon));
        this.mSearchHintIcon = a.getDrawable(R.styleable.SearchView_android_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(R.styleable.SearchView_android_suggestionRowLayout, R.layout.op_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(R.styleable.SearchView_android_commitIcon, 0);
        ...
        setIconifiedByDefault(a.getBoolean(R.styleable.SearchView_android_iconifiedByDefault, true));
        ...
        this.mQueryHint = a.getText(R.styleable.SearchView_android_queryHint);
    ...
    private int getPaddingLeftInActionBar(Context context) {
        int backIconWidth = context.getResources().getDimensionPixelSize(R.dimen.toolbar_icon_min_width);
        int marginLeft2 = context.getResources().getDimensionPixelSize(R.dimen.oneplus_contorl_layout_margin_left2);
        return (context.getResources().getDimensionPixelSize(R.dimen.oneplus_contorl_layout_margin_left4) - backIconWidth) - (marginLeft2 - ((backIconWidth - context.getResources().getDimensionPixelSize(R.dimen.oneplus_contorl_icon_size_button)) / 2));
    }
    ...
    private void updateCloseButton() {
        boolean enable = true;
        if (!(TextUtils.isEmpty(this.mSearchSrcTextView.getText()) ^ true) && (!this.mIconifiedByDefault || this.mExpandedInActionView)) {
            enable = false;
        }
        this.mCloseButton.setEnabled(enable);
    }
    ...
    private Intent createIntent(String action, Uri data, String extraData, String query, int actionKey, String actionMsg) {
        ...
        if (query != null) {
            intent.putExtra(SavedQueriesColumns.QUERY, query);
        }
        if (extraData != null) {
