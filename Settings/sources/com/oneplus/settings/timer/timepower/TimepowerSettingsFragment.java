...
public class TimepowerSettingsFragment extends SettingsPreferenceFragment implements OnTimeSetListener, OnPreferenceChangeListener {
    ...
    private void startDialogForResult(Intent data, int code) {
        if (data != null) {
            this.mCode = code;
            this.mTimePicker = new TimePicker(new ContextThemeWrapper(getActivity(), (int) R.style.f968Theme.Settings.TimePicker));
            ...
            TimePickerDialog timePickerDialog = new TimePickerDialog(getActivity(), R.style.f280OnePlus.Theme.Dialog.Picker, this, mDlgHour, mDlgMinute, mIs24Hour);
