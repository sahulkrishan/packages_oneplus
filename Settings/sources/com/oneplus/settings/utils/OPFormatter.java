...
public final class OPFormatter {
    ...
    private static String formatRoundedBytesResult(Context context, RoundedBytesResult input) {
        ...
        return context.getString(17039919, new Object[]{numberFormatter.format((double) input.value), getSuffixOverride(context.getResources(), input.units)});
    }
