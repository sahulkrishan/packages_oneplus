...
public class OPGamingMode extends SettingsPreferenceFragment implements OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    public void onResume() {
        ...
        if (this.mNotificationsCalls != null) {
            SwitchPreference switchPreference = this.mNotificationsCalls;
            if (value == 0) {
                z = false;
            }
