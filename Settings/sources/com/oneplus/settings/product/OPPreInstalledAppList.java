...
public class OPPreInstalledAppList extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (Build.MODEL.equalsIgnoreCase(SettingsBaseApplication.mApplication.getResources().getString(R.string.oneplus_model_for_china_and_india)) || Build.MODEL.equalsIgnoreCase(SettingsBaseApplication.mApplication.getResources().getString(R.string.oneplus_model_for_europe_and_america))) {
