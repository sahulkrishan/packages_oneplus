...
public class ChartView extends FrameLayout {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mOptimalWidth > 0 && slack > 0) {
            super.onMeasure(MeasureSpec.makeMeasureSpec((int) (((float) this.mOptimalWidth) + (((float) slack) * this.mOptimalWidthWeight)), Ints.MAX_POWER_OF_TWO), heightMeasureSpec);
        }
    }
    ...
    /* Access modifiers changed, original: protected */
    public void layoutSweep(ChartSweepView sweep) {
    ...
    /* Access modifiers changed, original: protected */
    public void layoutSweep(ChartSweepView sweep, Rect parentRect, Rect childRect) {
