...
public class FingerprintEnrollFindSensor extends FingerprintEnrollBase {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            this.mLaunchedConfirmLock = savedInstanceState.getBoolean(EXTRA_KEY_LAUNCHED_CONFIRM);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(EXTRA_KEY_LAUNCHED_CONFIRM, this.mLaunchedConfirmLock);
