...
public class SimStatusDialogController implements LifecycleObserver, OnResume, OnPause {
    ...
    @VisibleForTesting
    static final int CELLULAR_NETWORK_STATE = 2131362151;
    private static final String CELL_BROADCAST_RECEIVER_APP = "com.android.cellbroadcastreceiver";
    @VisibleForTesting
    static final int CELL_DATA_NETWORK_TYPE_VALUE_ID = 2131362147;
    @VisibleForTesting
    static final int CELL_VOICE_NETWORK_TYPE_VALUE_ID = 2131363311;
    @VisibleForTesting
    static final int EID_INFO_VALUE_ID = 2131362265;
    private static final String GET_LATEST_CB_AREA_INFO_ACTION = "com.android.cellbroadcastreceiver.GET_LATEST_CB_AREA_INFO";
    @VisibleForTesting
    static final int ICCID_INFO_LABEL_ID = 2131362397;
    @VisibleForTesting
    static final int ICCID_INFO_VALUE_ID = 2131362398;
    @VisibleForTesting
    static final int IMS_REGISTRATION_STATE_LABEL_ID = 2131362426;
    @VisibleForTesting
    static final int IMS_REGISTRATION_STATE_VALUE_ID = 2131362427;
    @VisibleForTesting
    static final int NETWORK_PROVIDER_VALUE_ID = 2131362795;
    @VisibleForTesting
    static final int OPERATOR_INFO_LABEL_ID = 2131362517;
    @VisibleForTesting
    static final int OPERATOR_INFO_VALUE_ID = 2131362518;
    @VisibleForTesting
    static final int PHONE_NUMBER_VALUE_ID = 2131362685;
    @VisibleForTesting
    static final int ROAMING_INFO_VALUE_ID = 2131362962;
    @VisibleForTesting
    static final int SERVICE_STATE_VALUE_ID = 2131363038;
    @VisibleForTesting
    static final int SIGNAL_STRENGTH_LABEL_ID = 2131363062;
    @VisibleForTesting
    static final int SIGNAL_STRENGTH_VALUE_ID = 2131363063;
    ...
    private void updateLatestAreaInfo() {
        boolean z = Resources.getSystem().getBoolean(17957022) && this.mTelephonyManager.getPhoneType() != 2;
