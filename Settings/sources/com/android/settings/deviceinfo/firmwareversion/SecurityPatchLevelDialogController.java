...
public class SecurityPatchLevelDialogController implements OnClickListener {
    ...
    @VisibleForTesting
    static final int SECURITY_PATCH_LABEL_ID = 2131363014;
    @VisibleForTesting
    static final int SECURITY_PATCH_VALUE_ID = 2131363015;
    ...
    public void onClick(View v) {
        ...
        if (this.mPackageManager.queryIntentActivities(intent, 0).isEmpty()) {
            Log.w(TAG, "Stop click action on 2131363015: queryIntentActivities() returns empty");
        } else {
