...
public class TetherService extends Service {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (TetherService.this.getResources().getString(17039724).equals(intent.getAction())) {
    ...
    public void onCreate() {
        ...
        registerReceiver(this.mReceiver, new IntentFilter(getResources().getString(17039724)), "android.permission.CONNECTIVITY_INTERNAL", null);
    ...
    private Intent getProvisionBroadcastIntent(int index) {
        Intent intent = new Intent(getResources().getString(17039723));
