...
public class DisplaySettings extends SettingsPreferenceFragment implements CustomColorClickListener, OnPreferenceChangeListener, OnPreferenceClickListener, OPCallbackBrightness, Indexable {
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            if (!context.getResources().getBoolean(17956944)) {
            ...
            if (!OPUtils.isSupportScreenDisplayAdaption() || OPUtils.isSupportScreenCutting()) {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (this.ACCESSIBILITY_DISPLAY_DALTONIZER_ENABLED_URI.equals(uri) || this.ACCESSIBILITY_DISPLAY_INVERSION_ENABLED_URI.equals(uri)) {
                ...
                if (DisplaySettings.this.mNightModePreference != null) {
                    ...
                    z = (isDisplayDaltonizeEnabled || isDisplayInversionEnabled) ? false : true;
    ...
    private SwitchPreference mVideoEnhancerPreference;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!(this.mScreenSaverPreference == null || getResources().getBoolean(17956944))) {
        ...
        this.mVideoEnhancerPreference = (SwitchPreference) findPreference(KEY_VIDEO_ENHANCER);
        if (this.mVideoEnhancerPreference != null) {
            this.mVideoEnhancerPreference.setOnPreferenceChangeListener(this);
        }
        ...
        if (OPUtils.isSupportScreenCutting()) {
            ...
            if (!OPUtils.isSupportScreenDisplayAdaption()) {
                this.mScreenBrightnessRootPreference.removePreference(this.mDisplaySizeAdaptionPreference);
            }
        }
    ...
    private static boolean isTapToWakeAvailable(Resources res) {
        return res.getBoolean(17957041);
    }
    ...
    private static boolean isCameraDoubleTapPowerGestureAvailable(Resources res) {
        return res.getBoolean(17956908);
    }
    ...
    private void updateState() {
        ...
        if (this.mVideoEnhancerPreference != null) {
            this.mVideoEnhancerPreference.setChecked(SystemProperties.getBoolean("persist.sys.oem.vendor.media.vpp.enable", false));
        }
