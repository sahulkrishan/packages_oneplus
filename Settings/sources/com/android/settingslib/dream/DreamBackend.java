...
public class DreamBackend {
    ...
    public DreamBackend(Context context) {
        ...
        this.mDreamsEnabledByDefault = context.getResources().getBoolean(17956942);
        this.mDreamsActivatedOnSleepByDefault = context.getResources().getBoolean(17956941);
        this.mDreamsActivatedOnDockByDefault = context.getResources().getBoolean(17956940);
    }
