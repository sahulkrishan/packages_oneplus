...
class SlideKitkat extends Visibility {
    ...
    private Animator createAnimation(View view, Property<View, Float> property, float start, float end, float terminalValue, TimeInterpolator interpolator, int finalVisibility) {
        ...
        float[] startPosition = (float[]) view2.getTag(R.id.lb_slide_transition_value);
        if (startPosition != null) {
            float start3 = View.TRANSLATION_Y == property2 ? startPosition[1] : startPosition[0];
            view2.setTag(R.id.lb_slide_transition_value, null);
            start2 = start3;
        } else {
            start2 = start;
        }
        ObjectAnimator anim = ObjectAnimator.ofFloat(view2, property2, new float[]{start2, end});
        SlideAnimatorListener listener = new SlideAnimatorListener(view2, property2, terminalValue, end, finalVisibility);
