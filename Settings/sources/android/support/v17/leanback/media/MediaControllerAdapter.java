...
public class MediaControllerAdapter extends PlayerAdapter {
    ...
    Callback mMediaControllerCallback = new Callback() {
    ...
    public Drawable getMediaArt(Context context) {
        ...
        Bitmap bitmap = this.mController.getMetadata().getDescription().getIconBitmap();
        if (bitmap != null) {
    ...
    public long getSupportedActions() {
        ...
        if ((PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE & actionsFromController) != 0) {
            supportedActions |= PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID;
        }
