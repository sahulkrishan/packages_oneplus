...
public class VideoSupportFragment extends PlaybackSupportFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mVideoSurface = (SurfaceView) LayoutInflater.from(getContext()).inflate(R.layout.lb_video_surface, root, false);
        ...
        this.mVideoSurface.getHolder().addCallback(new Callback() {
            public void surfaceCreated(SurfaceHolder holder) {
                if (VideoSupportFragment.this.mMediaPlaybackCallback != null) {
                    VideoSupportFragment.this.mMediaPlaybackCallback.surfaceCreated(holder);
                }
            ...
            public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
                if (VideoSupportFragment.this.mMediaPlaybackCallback != null) {
                    VideoSupportFragment.this.mMediaPlaybackCallback.surfaceChanged(holder, format, width, height);
                }
            }

            public void surfaceDestroyed(SurfaceHolder holder) {
                if (VideoSupportFragment.this.mMediaPlaybackCallback != null) {
                    VideoSupportFragment.this.mMediaPlaybackCallback.surfaceDestroyed(holder);
                }
