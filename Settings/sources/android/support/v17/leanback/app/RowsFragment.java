...
import android.support.v17.leanback.app.BrowseFragment.FragmentHost;
import android.support.v17.leanback.app.BrowseFragment.MainFragmentAdapterProvider;
import android.support.v17.leanback.app.BrowseFragment.MainFragmentRowsAdapterProvider;
...
public class RowsFragment extends BaseRowFragment implements MainFragmentRowsAdapterProvider, MainFragmentAdapterProvider {
    ...
    public static class MainFragmentAdapter extends android.support.v17.leanback.app.BrowseFragment.MainFragmentAdapter<RowsFragment> {
    ...
    @Deprecated
    public static class MainFragmentRowsAdapter extends android.support.v17.leanback.app.BrowseFragment.MainFragmentRowsAdapter<RowsFragment> {
    ...
    public android.support.v17.leanback.app.BrowseFragment.MainFragmentAdapter getMainFragmentAdapter() {
    ...
    public android.support.v17.leanback.app.BrowseFragment.MainFragmentRowsAdapter getMainFragmentRowsAdapter() {
                ...
                task = new android.support.v17.leanback.widget.ViewHolderTask() {
                    public void run(final RecyclerView.ViewHolder rvh) {
                        rvh.itemView.post(new Runnable() {
                            public void run() {
                                rowHolderTask.run(RowsFragment.getRowViewHolder((ViewHolder) rvh));
                            }
                        });
                    }
                };
