...
public class MediaNowPlayingView extends LinearLayout {
    ...
    public MediaNowPlayingView(Context context, AttributeSet attrs) {
        ...
        this.mImage1.setPivotY((float) this.mImage1.getDrawable().getIntrinsicHeight());
        this.mImage2.setPivotY((float) this.mImage2.getDrawable().getIntrinsicHeight());
        this.mImage3.setPivotY((float) this.mImage3.getDrawable().getIntrinsicHeight());
        ...
        this.mObjectAnimator1.setDuration(2320);
        ...
        this.mObjectAnimator2.setDuration(2080);
        ...
        this.mObjectAnimator3.setDuration(2000);
