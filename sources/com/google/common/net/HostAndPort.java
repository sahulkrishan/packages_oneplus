...
public final class HostAndPort implements Serializable {
    ...
    private static String[] getHostAndPortFromBracketedHost(String hostPortString) {
        ...
        Preconditions.checkArgument(hostPortString.charAt(closeBracketIndex + 1) == AccessibilityUtils.ENABLED_ACCESSIBILITY_SERVICES_SEPARATOR, "Only a colon may follow a close bracket: %s", hostPortString);
    ...
    public String toString() {
        ...
        if (hasPort()) {
            builder.append(AccessibilityUtils.ENABLED_ACCESSIBILITY_SERVICES_SEPARATOR);
