...
public class ExceptionReporter implements UncaughtExceptionHandler {
    ...
    public ExceptionReporter(Tracker tracker, ServiceManager serviceManager, UncaughtExceptionHandler originalHandler, Context context) {
        if (tracker == null) {
            ...
            stringBuilder.append("ExceptionReporter created, original handler is ");
            stringBuilder.append(originalHandler == null ? "null" : originalHandler.getClass().getName());
    ...
    public void uncaughtException(Thread t, Throwable e) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Tracking Exception: ");
