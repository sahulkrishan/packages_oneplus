...
public class ApplicationsState {
    ...
    public static final AppFilter FILTER_NOT_HIDE = new AppFilter() {
        ...
        public void init(Context context) {
            this.mHidePackageNames = context.getResources().getStringArray(17236016);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    while (it2.hasNext()) {
                        Session session2 = (Session) ((WeakReference) it2.next()).get();
                    ...
                    return;
                case 2:
                    it = ApplicationsState.this.mActiveSessions.iterator();
                    while (it.hasNext()) {
                        session = (Session) ((WeakReference) it.next()).get();
                        if (session != null) {
                ...
                case 4:
                    ...
                    while (it.hasNext()) {
                        session = (Session) ((WeakReference) it.next()).get();
                        if (session != null) {
                            session.mCallbacks.onPackageSizeChanged((String) msg.obj);
                        }
                    }
                    return;
                case 5:
                ...
                case 6:
                    ...
                    while (it.hasNext()) {
                        session = (Session) ((WeakReference) it.next()).get();
                        if (session != null) {
                            session.mCallbacks.onRunningStateChanged(msg.arg1 != 0);
                        }
                    }
                    return;
                case 7:
