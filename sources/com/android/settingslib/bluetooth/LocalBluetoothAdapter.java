        ...
        if (!this.mAdapter.isDiscovering()) {
            if (!force) {
                if (this.mLastScan + 300000 > System.currentTimeMillis()) {
                    Log.d(TAG, "Don't scan more than frequently than SCAN_EXPIRATION_MS");
                    return;
                }
                ...
                if (a2dp == null || !a2dp.isA2dpPlaying()) {
                    ...
                    if (a2dpSink != null && a2dpSink.isA2dpPlaying()) {
                        Log.d(TAG, "a2dpSink is playing");
                        return;
                    }
                }
                Log.d(TAG, "a2dp is playing");
                return;
            }
            if (this.mAdapter.startDiscovery()) {
                Log.d(TAG, "local bluetooth adapter to start discovery");
