...
class ConfigDialog extends AlertDialog implements TextWatcher, OnClickListener, OnItemSelectedListener, OnCheckedChangeListener {
    ...
    private void changeType(int r7) {
        ...
        r0.setVisibility(r1);
        r0 = r6.mView;
        r2 = 2131362495; // 0x7f0a02bf float:1.8344772E38 double:1.0530329876E-314;
        r0 = r0.findViewById(r2);
        r0.setVisibility(r1);
        r0 = r6.mView;
        r3 = 2131362474; // 0x7f0a02aa float:1.834473E38 double:1.053032977E-314;
        r0 = r0.findViewById(r3);
        r0.setVisibility(r1);
        r0 = r6.mView;
        r4 = 2131362477; // 0x7f0a02ad float:1.8344736E38 double:1.0530329787E-314;
        r0 = r0.findViewById(r4);
        r0.setVisibility(r1);
        r0 = r6.mView;
        r5 = 2131362473; // 0x7f0a02a9 float:1.8344728E38 double:1.0530329767E-314;
