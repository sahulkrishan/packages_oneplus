...
public class PrivateVolumeSettings extends SettingsPreferenceFragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.storage_format /*2131363120*/:
                ...
                return true;
            case R.id.storage_free /*2131363121*/:
                startActivity(new Intent("android.os.storage.action.MANAGE_STORAGE"));
                return true;
            case R.id.storage_migrate /*2131363123*/:
                ...
                return true;
            case R.id.storage_mount /*2131363124*/:
                new MountTask(context, this.mVolume).execute(new Void[0]);
                return true;
            case R.id.storage_rename /*2131363126*/:
                RenameFragment.show(this, this.mVolume);
                return true;
            case R.id.storage_unmount /*2131363128*/:
                args.putString("android.os.storage.extra.VOLUME_ID", this.mVolume.getId());
    ...
    public boolean onPreferenceTreeClick(Preference pref) {
        ...
        if (itemTitleId != 0) {
            if (itemTitleId != R.string.storage_menu_explore) {
                switch (itemTitleId) {
                    case R.string.storage_detail_apps /*2131890603*/:
                        Bundle args = new Bundle();
                        ...
                        break;
                    case R.string.storage_detail_audio /*2131890604*/:
                        intent = getIntentForStorage(AUTHORITY_MEDIA, "audio_root");
                        break;
                    case R.string.storage_detail_cached /*2131890605*/:
                        ConfirmClearCacheFragment.show(this);
                        return true;
                    default:
                        switch (itemTitleId) {
                            case R.string.storage_detail_images /*2131890610*/:
                                intent = getIntentForStorage(AUTHORITY_MEDIA, "images_root");
                                break;
                            case R.string.storage_detail_other /*2131890611*/:
                                OtherInfoFragment.show(this, this.mStorageManager.getBestVolumeDescription(this.mVolume), this.mSharedVolume, userId);
                                return true;
                            case R.string.storage_detail_system /*2131890612*/:
                                SystemInfoFragment.show(this);
                                return true;
                            case R.string.storage_detail_videos /*2131890613*/:
    ...
    L_0x0030:
        ...
        r15 = 1;
        switch(r0) {
            case 2131890603: goto L_0x00b2;
            case 2131890604: goto L_0x008e;
            case 2131890605: goto L_0x0082;
            default: goto L_0x0035;
        };
    L_0x0035:
        switch(r0) {
            case 2131890610: goto L_0x006d;
            case 2131890611: goto L_0x0054;
            case 2131890612: goto L_0x004b;
            case 2131890613: goto L_0x003c;
