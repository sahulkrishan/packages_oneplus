...
public class SwipeUpPreferenceController extends GesturePreferenceController {
    ...
    static boolean isGestureAvailable(Context context) {
        ...
        if (context.getPackageManager().resolveService(new Intent(ACTION_QUICKSTEP).setPackage(ComponentName.unflattenFromString(context.getString(17039737)).getPackageName()), 1048576) == null) {
            return false;
        }
        return true;
    }
