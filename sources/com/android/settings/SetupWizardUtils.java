...
public class SetupWizardUtils {
    ...
    public static int getTheme(Intent intent) {
        ...
        if (OPUtils.isO2()) {
            return R.style.f948Theme.Oneplus.SetupWizardTheme.Oxygen;
        }
        return R.style.f945Theme.Oneplus.SetupWizardTheme.Hydrogen;
    }

    public static int getSettingTheme() {
        return R.style.f943Theme.Oneplus.SetupFingerprintEnroll;
    }

    public static int getOxygenTheme(Intent intent) {
        if (OPUtils.isO2()) {
            return R.style.f947Theme.Oneplus.SetupWizardTheme.Light.Oxygen;
        }
        return R.style.f946Theme.Oneplus.SetupWizardTheme.Light.Hydrogen;
    }

    public static int getOxygenSettingTheme() {
        return R.style.f941Theme.Oneplus.Oxygen.SetupFingerprintEnroll;
    }
    ...
    public static int getTransparentTheme(Intent intent) {
        ...
        if (suwTheme == R.style.f176GlifTheme.Light) {
            return R.style.f733SetupWizardTheme.Light.Transparent;
        }
        if (suwTheme == R.style.GlifTheme) {
            return R.style.f734SetupWizardTheme.Transparent;
        }
