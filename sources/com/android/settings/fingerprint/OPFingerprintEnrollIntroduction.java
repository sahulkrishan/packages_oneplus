...
public class OPFingerprintEnrollIntroduction extends FingerprintEnrollBase implements OnClickListener, LinkSpan.OnClickListener {
    ...
    private static final int FINISH_FINGERPRINT_REQUEST = 100;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.functional_terms)).setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(OPFingerprintEnrollIntroduction.OPLEGAL_NOTICES_ACTION);
                intent.putExtra(OPFingerprintEnrollIntroduction.KEY_NOTICES_TYPE, 8);
                intent.putExtra(OPFingerprintEnrollIntroduction.KEY_FROM_SETTINGS, true);
                OPFingerprintEnrollIntroduction.this.startActivity(intent);
            }
        });
