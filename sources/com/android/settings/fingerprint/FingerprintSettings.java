...
public class FingerprintSettings extends SubSettings {
     ...
     */
        ...
        private int getCustomAnimationName() {
            int style = System.getIntForUser(getContext().getContentResolver(), OPConstants.OP_CUSTOM_UNLOCK_ANIMATION_STYLE_KEY, 0, -2);
            if (!OPUtils.isSM8150Products()) {
                ...
                return R.string.oneplus_select_fingerprint_animation_effect_none;
            } else {
                switch (style) {
                    case 0:
                        return R.string.oneplus_select_fingerprint_animation_effect_1;
                    case 1:
                        return R.string.oneplus_select_fingerprint_animation_effect_4;
                    case 2:
                        return R.string.oneplus_select_fingerprint_animation_effect_3;
                    case 3:
                        return R.string.op_theme_3_title;
