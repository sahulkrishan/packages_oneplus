...
public class FingerprintEnrollEnrolling extends FingerprintEnrollBase implements Listener, OnOPFingerComfirmListener {
    ...
    private static final int FINGERPRINT_ACQUIRED_TOUCH_DOWN = 1000;
    ...
    private static final int FINISH_DELAY = 750;
    ...
    private IFingerprintService ifp = Stub.asInterface(ServiceManager.getService("fingerprint"));
    ...
    private final Runnable mDelayedShowLottieRunnable = new Runnable() {
        public void run() {
    ...
    private final AnimatorListener mProgressAnimationListener = new AnimatorListener() {
        ...
        public void onAnimationEnd(Animator animation) {
            if (FingerprintEnrollEnrolling.this.mProgressBar.getProgress() >= 10000) {
                FingerprintEnrollEnrolling.this.mProgressBar.postDelayed(FingerprintEnrollEnrolling.this.mDelayedFinishRunnable, 750);
            }
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (OPUtils.isSupportCustomFingerprint()) {
            if (this.overlayLayoutId != -1) {
                ...
                layoutId = R.layout.op_fod_setup_fingerprint_enroll_enrolling_base;
            } else {
                layoutId = R.layout.op_fod_fingerprint_enroll_enrolling_base;
            }
        ...
        if (OPUtils.isSupportCustomFingerprint()) {
            this.mNextButton = (Button) findViewById(R.id.continue_enroll_button);
        ...
        this.mErrorAnimator = AnimatorInflater.loadAnimator(this, R.anim.shake_anim);
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.continue_enroll_button) {
            resumeEnroll(true, 8);
    ...
    public void onEnrollmentHelp(int helpMsgId, CharSequence helpString) {
        ...
        if (OPUtils.isSupportCustomFingerprint()) {
            ...
            } else if (this.mOPFingerPrintEnrollView != null) {
                this.mOPFingerPrintEnrollView.startTouchDownAnim();
            }
    ...
    private void showError(CharSequence error) {
        this.mRepeatMessage.setText(error);
