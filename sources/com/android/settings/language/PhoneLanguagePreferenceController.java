...
public class PhoneLanguagePreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    public boolean isAvailable() {
        ...
        stringBuilder.append(isO2);
        Log.d("PhoneLanguagePreferenceController", stringBuilder.toString());
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        new SubSettingLauncher(this.mContext).setDestination(LocaleListEditor.class.getName()).setSourceMetricsCategory(750).setTitle((int) R.string.pref_title_lang_selection).launch();
        return true;
    }
}
