...
public class AccessibilitySettings extends SettingsPreferenceFragment implements OnPreferenceChangeListener, Indexable {
    ...
    private void disableEntryForWellbeingGrayscale() {
        ...
        if (isWellbeingGrayscaleEnabled) {
            if (this.mDisplayDaltonizerPreferenceScreen != null) {
                this.mDisplayDaltonizerPreferenceScreen.setEnabled(!isWellbeingGrayscaleEnabled);
            }
