...
public class SearchIndexableResourcesImpl implements SearchIndexableResources {
    ...
    public void addIndex(Class indexClass) {
        this.sProviders.add(indexClass);
    }
    ...
    public SearchIndexableResourcesImpl() {
        ...
        addIndex(OPToolsSettings.class);
        addIndex(OPButtonsAndGesturesSettings.class);
        addIndex(OPNavigationBarGesturesSettings.class);
        addIndex(OPButtonCustomSettings.class);
        addIndex(WifiTetherSettings.class);
        addIndex(OPStatusBarCustomizeSettings.class);
        addIndex(OPGestureSettings.class);
        addIndex(OPAboutPhone.class);
        addIndex(OPProductInfoSettings.class);
        addIndex(OPCarChargerSettings.class);
        addIndex(OPGamingMode.class);
        addIndex(OPQuickReplySettings.class);
        addIndex(OPQuickLaunchSettings.class);
        addIndex(OPScreenResolutionAdjust.class);
        addIndex(OPScreenRefreshRate.class);
        addIndex(OPFaceUnlockModeSettings.class);
    }
