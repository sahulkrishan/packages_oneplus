...
public class KeyboardLayoutPickerFragment extends SettingsPreferenceFragment implements InputDeviceListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        this.mInputDeviceIdentifier = (InputDeviceIdentifier) getActivity().getIntent().getParcelableExtra(EXTRA_INPUT_DEVICE_IDENTIFIER);
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        for (KeyboardLayout layout : this.mKeyboardLayouts) {
            ...
            pref.setTitle((CharSequence) layout.getLabel());
            pref.setSummary((CharSequence) layout.getCollection());
