...
public class KeyboardLayoutDialogFragment extends InstrumentedDialogFragment implements InputDeviceListener, LoaderCallbacks<Keyboards> {
    ...
    private static final class KeyboardLayoutAdapter extends ArrayAdapter<KeyboardLayout> {
        ...
        private View inflateTwoLine(View convertView, ViewGroup parent, String label, String collection, boolean checked) {
            View view = convertView;
            if (view == null || !isTwoLine(view)) {
                view = this.mInflater.inflate(17367284, parent, false);
                setTwoLine(view, true);
            }
            TextView subText = (TextView) view.findViewById(16908309);
            RadioButton radioButton = (RadioButton) view.findViewById(16909214);
    ...
    private static final class KeyboardLayoutLoader extends AsyncTaskLoader<Keyboards> {
        ...
        public Keyboards loadInBackground() {
            ...
            if (currentKeyboardLayoutDescriptor != null) {
                size = keyboards.keyboardLayouts.size();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            this.mInputDeviceIdentifier = (InputDeviceIdentifier) savedInstanceState.getParcelable(KEY_INPUT_DEVICE_IDENTIFIER);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelable(KEY_INPUT_DEVICE_IDENTIFIER, this.mInputDeviceIdentifier);
    }

    public Dialog onCreateDialog(Bundle savedInstanceState) {
        Context context = getActivity();
        Builder builder = new Builder(context).setTitle(R.string.keyboard_layout_dialog_title).setPositiveButton(R.string.keyboard_layout_dialog_setup_button, new OnClickListener() {
        ...
        }).setView(LayoutInflater.from(context).inflate(R.layout.keyboard_layout_dialog_switch_hint, null));
    ...
    private void updateSwitchHintVisibility() {
        AlertDialog dialog = (AlertDialog) getDialog();
        if (dialog != null) {
            dialog.findViewById(16908820).setVisibility(this.mAdapter.getCount() > 1 ? 0 : 8);
        }
    }
}
