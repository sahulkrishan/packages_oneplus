...
public class SettingsActivity extends SettingsDrawerActivity implements OnPreferenceTreeClickListener, OnPreferenceStartFragmentCallback, ButtonBarHandler, OnBackStackChangedListener {
    ...
    public void onCreate(Bundle savedState) {
        ...
        if (isSubSettings) {
            setTheme(R.style.f959Theme.SubSettings);
        }
    ...
    private void doUpdateTilesList() {
        ...
        z = setTileEnabled(changedList, new ComponentName(packageName, OPVoiceAssistantSettingsActivity.class.getName()), false, isAdmin) || z;
        somethingChanged = z;
