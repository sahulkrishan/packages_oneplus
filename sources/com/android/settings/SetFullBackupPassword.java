...
public class SetFullBackupPassword extends Activity {
        ...
        public void onClick(View v) {
            if (v == SetFullBackupPassword.this.mSet) {
                ...
                if (!newPw.equals(SetFullBackupPassword.this.mConfirmNewPw.getText().toString())) {
                    Log.i(SetFullBackupPassword.TAG, "password mismatch");
                    ...
                    Log.i(SetFullBackupPassword.TAG, "password set successfully");
                    ...
                    Log.i(SetFullBackupPassword.TAG, "failure; password mismatch?");
                ...
                Log.w(SetFullBackupPassword.TAG, "Click on unknown view");
            }
        }
    };
    Button mCancel;
    ...
    public void onCreate(Bundle icicle) {
        ...
        actionBar.setTitle(R.string.local_backup_password_title);
