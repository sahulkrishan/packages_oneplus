            ...
            widgetView.setOnClickListener(new OnClickListener() {
                public void onClick(View v) {
                    if (MasterSwitchPreference.this.mSwitch == null || MasterSwitchPreference.this.mSwitch.isEnabled()) {
                        if (VibratorSceneUtils.systemVibrateEnabled(MasterSwitchPreference.this.getContext())) {
                            MasterSwitchPreference.this.mVibratePattern = VibratorSceneUtils.getVibratorScenePattern(MasterSwitchPreference.this.getContext(), MasterSwitchPreference.this.mVibrator, 1003);
                            VibratorSceneUtils.vibrateIfNeeded(MasterSwitchPreference.this.mVibratePattern, MasterSwitchPreference.this.mVibrator);
                        }
