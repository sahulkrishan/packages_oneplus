    ...
    public void onBindTile(DashboardItemHolder holder, Tile tile) {
        ...
        if (tile != null) {
            ...
            if (tileIntent != null) {
                ...
                if (cName != null && OPConstants.PACKAGENAME_WELLBEING.equals(cName.getPackageName())) {
                    icon = this.mContext.getDrawable(R.drawable.op_ic_homepage_wellbeing);
                    this.mCache.updateIcon(tile.icon, icon);
                }
            }
        }
