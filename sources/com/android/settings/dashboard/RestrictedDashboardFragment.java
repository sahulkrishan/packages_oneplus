...
public abstract class RestrictedDashboardFragment extends DashboardFragment {
    ...
    public void onDataSetChanged() {
        ...
        if (isUiRestrictedByOnlyAdmin() && (this.mActionDisabledDialog == null || !this.mActionDisabledDialog.isShowing())) {
            this.mActionDisabledDialog = new ActionDisabledByAdminDialogHelper(getActivity()).prepareDialogBuilder(this.mRestrictionKey, getRestrictionEnforcedAdmin()).setOnDismissListener(new -$$Lambda$RestrictedDashboardFragment$xeipMNP1JUFbhaWoStBNgM1y67g(this)).show();
