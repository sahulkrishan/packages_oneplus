...
public class RunningState {
    ...
    /* JADX WARNING: Missing block: B:388:0x0822, code skipped:
            return r26;
     */
    private boolean update(android.content.Context r44, android.app.ActivityManager r45) {
        /*
        r43 = this;
        r1 = r43;
        r2 = r44;
    ...
    L_0x0465:
        r15 = r14.next();
        r15 = (com.android.settings.applications.RunningState.ServiceItem) r15;
        r15.mNeedDivider = r9;
        r9 = 1;
        r4.add(r15);
        r31 = r3;
    ...
    L_0x04b9:
        ...
        r3 = r7;
    L_0x04c1:
        r14 = r1.mProcessItems;
        r14 = r14.size();
        r15 = 1;
        r14 = r14 - r15;
        if (r3 >= r14) goto L_0x04db;
    L_0x04cb:
        r14 = r8.mOtherProcesses;
    ...
    L_0x0566:
        r6 = r1.mLock;
        monitor-enter(r6);
        r1.mItems = r4;	 Catch:{ all -> 0x0571 }
        r1.mMergedItems = r5;	 Catch:{ all -> 0x0571 }
        monitor-exit(r6);	 Catch:{ all -> 0x0571 }
        r30 = r8;
        goto L_0x057a;
    L_0x0571:
        r0 = move-exception;
    ...
    L_0x0598:
        ...
        r14 = r9.mCurSeq;
        r15 = r1.mSequence;
        if (r14 == r15) goto L_0x05e5;
    L_0x05a6:
        r14 = r9.mRunningProcessInfo;
        r14 = r14.importance;
        if (r14 < r8) goto L_0x05b4;
    L_0x05ac:
        r3 = r3 + 1;
    ...
    L_0x05ea:
        ...
        r16 = 0;
        r25 = r16;
        r0 = r1.mAllProcessItems;	 Catch:{ RemoteException -> 0x0730 }
        r0 = r0.size();	 Catch:{ RemoteException -> 0x0730 }
        r7 = new int[r0];	 Catch:{ RemoteException -> 0x0730 }
        r26 = r16;
    L_0x0601:
        r32 = r26;
        r8 = r32;
        if (r8 >= r0) goto L_0x0628;
    L_0x0607:
        r33 = r0;
        r0 = r1.mAllProcessItems;	 Catch:{ RemoteException -> 0x061c }
        r0 = r0.get(r8);	 Catch:{ RemoteException -> 0x061c }
        r0 = (com.android.settings.applications.RunningState.ProcessItem) r0;	 Catch:{ RemoteException -> 0x061c }
        r0 = r0.mPid;	 Catch:{ RemoteException -> 0x061c }
        r7[r8] = r0;	 Catch:{ RemoteException -> 0x061c }
        r26 = r8 + 1;
        r0 = r33;
        r8 = 400; // 0x190 float:5.6E-43 double:1.976E-321;
        goto L_0x0601;
    ...
    L_0x0628:
        r33 = r0;
        r0 = android.app.ActivityManager.getService();	 Catch:{ RemoteException -> 0x0730 }
        r0 = r0.getProcessPss(r7);	 Catch:{ RemoteException -> 0x0730 }
        r8 = 0;
        r26 = r13;
        r13 = r9;
        r9 = r8;
    ...
    L_0x0639:
        r34 = r5;
        r5 = r7.length;	 Catch:{ RemoteException -> 0x072a }
        if (r8 >= r5) goto L_0x0725;
    L_0x063e:
        r5 = r1.mAllProcessItems;	 Catch:{ RemoteException -> 0x072a }
        r5 = r5.get(r8);	 Catch:{ RemoteException -> 0x072a }
        r5 = (com.android.settings.applications.RunningState.ProcessItem) r5;	 Catch:{ RemoteException -> 0x072a }
        r35 = r10;
        r36 = r11;
        r10 = r0[r8];	 Catch:{ RemoteException -> 0x0723 }
        r37 = r0;
        r0 = r1.mSequence;	 Catch:{ RemoteException -> 0x0723 }
        r0 = r5.updateSize(r2, r10, r0);	 Catch:{ RemoteException -> 0x0723 }
        r26 = r26 | r0;
        r0 = r5.mCurSeq;	 Catch:{ RemoteException -> 0x0723 }
        r10 = r1.mSequence;	 Catch:{ RemoteException -> 0x0723 }
        if (r0 != r10) goto L_0x0666;
    L_0x065c:
        r10 = r5.mSize;	 Catch:{ RemoteException -> 0x0723 }
        r20 = r20 + r10;
        r38 = r7;
    L_0x0662:
        r7 = 200; // 0xc8 float:2.8E-43 double:9.9E-322;
        goto L_0x0715;
    L_0x0666:
        r0 = r5.mRunningProcessInfo;	 Catch:{ RemoteException -> 0x0723 }
        r0 = r0.importance;	 Catch:{ RemoteException -> 0x0723 }
        r10 = 400; // 0x190 float:5.6E-43 double:1.976E-321;
        if (r0 < r10) goto L_0x0707;
    L_0x066e:
        r10 = r5.mSize;	 Catch:{ RemoteException -> 0x0723 }
        r14 = r14 + r10;
        if (r13 == 0) goto L_0x0693;
    L_0x0673:
        r0 = new com.android.settings.applications.RunningState$MergedItem;	 Catch:{ RemoteException -> 0x0723 }
        r10 = r5.mUserId;	 Catch:{ RemoteException -> 0x0723 }
        r0.<init>(r10);	 Catch:{ RemoteException -> 0x0723 }
        r5.mMergedItem = r0;	 Catch:{ RemoteException -> 0x0723 }
        r10 = r5.mMergedItem;	 Catch:{ RemoteException -> 0x0723 }
        r10.mProcess = r5;	 Catch:{ RemoteException -> 0x0723 }
        r10 = r0.mUserId;	 Catch:{ RemoteException -> 0x0723 }
        r11 = r1.mMyUserId;	 Catch:{ RemoteException -> 0x0723 }
        if (r10 == r11) goto L_0x0688;
    L_0x0686:
        r10 = 1;
        goto L_0x068a;
    L_0x0688:
    ...
    L_0x068a:
        r25 = r25 | r10;
        r13.add(r0);	 Catch:{ RemoteException -> 0x0723 }
    L_0x068f:
        r38 = r7;
        goto L_0x06fc;
    L_0x0693:
        r0 = r1.mBackgroundItems;	 Catch:{ RemoteException -> 0x0723 }
        r0 = r0.size();	 Catch:{ RemoteException -> 0x0723 }
        if (r9 >= r0) goto L_0x06b1;
    L_0x069b:
        r0 = r1.mBackgroundItems;	 Catch:{ RemoteException -> 0x0723 }
        r0 = r0.get(r9);	 Catch:{ RemoteException -> 0x0723 }
        r0 = (com.android.settings.applications.RunningState.MergedItem) r0;	 Catch:{ RemoteException -> 0x0723 }
        r0 = r0.mProcess;	 Catch:{ RemoteException -> 0x0723 }
        if (r0 == r5) goto L_0x06a8;
    L_0x06a7:
        goto L_0x06b1;
    L_0x06a8:
        r0 = r1.mBackgroundItems;	 Catch:{ RemoteException -> 0x0723 }
        ...
        goto L_0x068f;
    L_0x06b1:
        r0 = new java.util.ArrayList;	 Catch:{ RemoteException -> 0x0723 }
        r0.<init>(r3);	 Catch:{ RemoteException -> 0x0723 }
        r10 = r0;
        r0 = r16;
    L_0x06b9:
        if (r0 >= r9) goto L_0x06dd;
    L_0x06bb:
        r11 = r1.mBackgroundItems;	 Catch:{ RemoteException -> 0x06d9 }
        r11 = r11.get(r0);	 Catch:{ RemoteException -> 0x06d9 }
        r11 = (com.android.settings.applications.RunningState.MergedItem) r11;	 Catch:{ RemoteException -> 0x06d9 }
        r13 = r11.mUserId;	 Catch:{ RemoteException -> 0x06d9 }
        r38 = r7;
        r7 = r1.mMyUserId;	 Catch:{ RemoteException -> 0x06d9 }
        if (r13 == r7) goto L_0x06cd;
    L_0x06cb:
        r7 = 1;
        goto L_0x06cf;
    L_0x06cd:
    ...
    L_0x06cf:
        r25 = r25 | r7;
        r10.add(r11);	 Catch:{ RemoteException -> 0x06d9 }
        r0 = r0 + 1;
        r7 = r38;
        goto L_0x06b9;
    L_0x06d9:
    ...
    L_0x06dd:
        r38 = r7;
        r0 = new com.android.settings.applications.RunningState$MergedItem;	 Catch:{ RemoteException -> 0x06d9 }
        r7 = r5.mUserId;	 Catch:{ RemoteException -> 0x06d9 }
        r0.<init>(r7);	 Catch:{ RemoteException -> 0x06d9 }
        r5.mMergedItem = r0;	 Catch:{ RemoteException -> 0x06d9 }
        r7 = r5.mMergedItem;	 Catch:{ RemoteException -> 0x06d9 }
        r7.mProcess = r5;	 Catch:{ RemoteException -> 0x06d9 }
        r7 = r0.mUserId;	 Catch:{ RemoteException -> 0x06d9 }
        r11 = r1.mMyUserId;	 Catch:{ RemoteException -> 0x06d9 }
        if (r7 == r11) goto L_0x06f4;
    L_0x06f2:
        r7 = 1;
        goto L_0x06f6;
    L_0x06f4:
    ...
    L_0x06f6:
        r25 = r25 | r7;
        r10.add(r0);	 Catch:{ RemoteException -> 0x06d9 }
        r13 = r10;
    L_0x06fc:
        r7 = 1;
        r0.update(r2, r7);	 Catch:{ RemoteException -> 0x0723 }
        r0.updateSize(r2);	 Catch:{ RemoteException -> 0x0723 }
        r9 = r9 + 1;
        goto L_0x0662;
    L_0x0707:
        r38 = r7;
    ...
    L_0x07f5:
        r11 = r1.mLock;
        monitor-enter(r11);
        r1.mNumBackgroundProcesses = r3;	 Catch:{ all -> 0x0823 }
        r1.mNumForegroundProcesses = r6;	 Catch:{ all -> 0x0823 }
        r1.mNumServiceProcesses = r4;	 Catch:{ all -> 0x0823 }
        r1.mBackgroundProcessMemory = r14;	 Catch:{ all -> 0x0823 }
        r1.mForegroundProcessMemory = r7;	 Catch:{ all -> 0x0823 }
        r1.mServiceProcessMemory = r9;	 Catch:{ all -> 0x0823 }
        if (r41 == 0) goto L_0x0813;
    L_0x0806:
        r13 = r41;
        r1.mBackgroundItems = r13;	 Catch:{ all -> 0x0828 }
        r1.mUserBackgroundItems = r5;	 Catch:{ all -> 0x0828 }
        r0 = r1.mWatchingBackgroundItems;	 Catch:{ all -> 0x0828 }
    ...
    L_0x0813:
        r13 = r41;
    L_0x0815:
        r0 = r1.mHaveData;	 Catch:{ all -> 0x0828 }
        if (r0 != 0) goto L_0x0821;
    L_0x0819:
        r12 = 1;
        r1.mHaveData = r12;	 Catch:{ all -> 0x0828 }
        r0 = r1.mLock;	 Catch:{ all -> 0x0828 }
        r0.notifyAll();	 Catch:{ all -> 0x0828 }
    L_0x0821:
        monitor-exit(r11);	 Catch:{ all -> 0x0828 }
        return r26;
    L_0x0823:
        r0 = move-exception;
        r13 = r41;
