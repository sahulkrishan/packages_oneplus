...
public class AppFilterRegistry {
    ...
    private AppFilterRegistry() {
        ...
        appFilterItemArr[18] = new AppFilterItem(appFilter2, 18, !OPUtils.isSupportScreenCutting() ? R.string.oneplus_app_display_compatibility : R.string.default_keyboard_layout);
