...
public class DrawOverlayDetails extends AppInfoWithHeader implements OnPreferenceChangeListener, OnPreferenceClickListener {
    ...
    public boolean refreshUi() {
        ...
        if ("com.oneplus.carmode".equals(this.mPackageName) || "com.android.dialer".equals(this.mPackageName) || ("com.oneplus.speechassist".equals(this.mPackageName) && isCardMode)) {
