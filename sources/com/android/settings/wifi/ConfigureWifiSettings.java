...
public class ConfigureWifiSettings extends DashboardFragment {
    ...
    public List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        ...
        controllers.add(new OPIntelligentlySelectBestWifiPreferenceController(context, getLifecycle()));
        controllers.add(new OPAutoSwitchMobileDataPreferenceController(context, getLifecycle()));
        controllers.add(new OPWifiScanAlwaysAvailablePreferenceController(context, getLifecycle()));
        controllers.add(new OPPasspointPreferenceController(context, getLifecycle()));
