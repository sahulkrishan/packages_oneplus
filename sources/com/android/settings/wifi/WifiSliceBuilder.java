...
public class WifiSliceBuilder {
    ...
    public static void handleUriChange(Context context, Intent intent) {
        ...
        boolean newState = intent.getBooleanExtra("android.app.slice.extra.TOGGLE_STATE", wifiManager.isWifiEnabled());
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("handleUriChange: setWifiEnabled: ");
        stringBuilder.append(newState);
        Log.d("WifiSliceBuilder", stringBuilder.toString());
