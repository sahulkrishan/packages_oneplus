...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        private void unbindFaceUnlockService() {
            ...
            try {
                ...
                Log.i(TAG, "UnBind oneplus face unlockservice exception");
            }
        }
        ...
        public void addHeaderView() {
            if (this.mForFingerprint) {
                setHeaderView(LayoutInflater.from(getActivity()).inflate(R.layout.op_password_choose_header_view, null));
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            if (requestCode == 100 && resultCode == -1) {
                ...
                if (OPUtils.isSupportCustomFingerprint()) {
                    launchFingerprintEnroll(data.getByteArrayExtra(ChooseLockSettingsHelper.EXTRA_KEY_CHALLENGE_TOKEN));
                } else {
        ...
        private void updatePreferenceText() {
            if (this.mForFingerprint) {
                setPreferenceTitle(ScreenLockType.PATTERN, (int) R.string.unlock_set_unlock_pattern_title);
                setPreferenceTitle(ScreenLockType.PIN, (int) R.string.unlock_set_unlock_pin_title);
                setPreferenceTitle(ScreenLockType.PASSWORD, (int) R.string.unlock_set_unlock_password_title);
                findPreference(ScreenLockType.PATTERN.preferenceKey).setIconSpaceReserved(false);
                findPreference(ScreenLockType.PIN.preferenceKey).setIconSpaceReserved(false);
                findPreference(ScreenLockType.PASSWORD.preferenceKey).setIconSpaceReserved(false);
                findPreference(KEY_SKIP_FINGERPRINT).setIconSpaceReserved(false);
            }
     ...
     */
        ...
        L_0x001a:
            ...
            r1 = r5.mCryptfsChangepwDefaultProgressDialog;
            r2 = r5.getResources();
            r3 = 2131889551; // 0x7f120d8f float:1.9413769E38 double:1.053293388E-314;
            r2 = r2.getString(r3);
            r1.setMessage(r2);
