...
public class SetupChooseLockGeneric extends ChooseLockGeneric {
    ...
    public static class SetupChooseLockGenericFragment extends ChooseLockGenericFragment {
        ...
        public void onViewCreated(View view, Bundle savedInstanceState) {
            ...
            layout.setIcon(getContext().getDrawable(R.drawable.op_ic_lock));
            int titleResource = this.mForFingerprint ? R.string.oneplus_choose_screen_lock_method : R.string.setup_lock_settings_picker_title;
            if (getActivity() != null) {
        ...
        public void addHeaderView() {
            if (this.mForFingerprint) {
                ...
                setHeaderView((int) R.layout.op_setup_password_choose_header_view);
            }
        }
