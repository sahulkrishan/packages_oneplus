...
public class SettingsDrawerActivity extends Activity {
    ...
    private CategoriesUpdateTask mCategoriesUpdateTask;
    ...
    private class PackageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            SettingsDrawerActivity.this.updateCategories();
        }
    }
    ...
    public void updateCategories() {
        cancelCategoriesUpdateTask();
        this.mCategoriesUpdateTask = new CategoriesUpdateTask();
        this.mCategoriesUpdateTask.execute(new Void[0]);
    }

    private void cancelCategoriesUpdateTask() {
        if (this.mCategoriesUpdateTask != null) {
            Log.d(TAG, "cancel categories update task");
            try {
                this.mCategoriesUpdateTask.cancel(true);
                this.mCategoriesUpdateTask = null;
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
