...
public class DisplaySizeAdaptionDetail extends DialogFragment implements OnClickListener, View.OnClickListener {
    ...
    public Checkable setup(View view, int value) {
        if (value == 1) {
            if (OPUtils.isSupportScreenCutting()) {
                ((TextView) view.findViewById(16908310)).setText(R.string.default_keyboard_layout);
            } else {
    ...
    public static CharSequence getSummary(Context context, String pkg) {
        ...
        if (value == 1) {
            if (OPUtils.isSupportScreenCutting()) {
                return SettingsBaseApplication.mApplication.getString(R.string.default_keyboard_layout);
            }
