...
public class OPUninstallFinish extends BroadcastReceiver {
    ...
    private void addDeviceManagerButton(@NonNull Context context, @NonNull Builder builder) {
        ...
        intent.setFlags(1342177280);
        builder.addAction(new Action.Builder(Icon.createWithResource(context, R.drawable.op_ic_lock), context.getString(R.string.manage_device_administrators), PendingIntent.getActivity(context, 0, intent, 134217728)).build());
    }
}
