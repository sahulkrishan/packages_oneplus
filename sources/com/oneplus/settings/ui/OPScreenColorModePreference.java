...
public class OPScreenColorModePreference extends Preference {
    private static final int layoutResId = 2131558825;
    private static final int layoutResId_2k = 2131558826;
    ...
    private void initView(Context context) {
        ...
        if (((WindowManager) this.mContext.getSystemService("window")).getDefaultDisplay().getWidth() == 1440) {
            setLayoutResource(R.layout.op_screen_color_mode_preference_2k);
        } else {
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        View view1 = mLi.inflate(R.layout.op_screen_image, null);
        ((ImageView) view1.findViewById(R.id.imageview)).setImageResource(R.drawable.op_screen_show_1);
        View view2 = mLi.inflate(R.layout.op_screen_image, null);
        ((ImageView) view2.findViewById(R.id.imageview)).setImageResource(R.drawable.op_screen_show_2);
        View view3 = mLi.inflate(R.layout.op_screen_image, null);
        ((ImageView) view3.findViewById(R.id.imageview)).setImageResource(R.drawable.op_screen_show_3);
