...
public class OPEarphoneMode extends SettingsPreferenceFragment implements OnPreferenceChangeListener, OnPreferenceClickListener, Indexable {
    ...
    private void updateNotificationRingtoneSummary(int value) {
        if (this.mNotificationRingtone != null) {
            ...
            this.mNotificationRingtone.setSummary(this.mContext.getResources().getStringArray(2130903186)[value]);
        }
    }
    ...
    private void confirmCallInformationBroadcast() {
        ...
        if (this.mDialog == null) {
            this.mDialog = new Builder(this.mContext).setTitle(R.string.oneplus_network_permission_alerts).setMessage(R.string.oneplus_network_permission_alerts_message).setPositiveButton(17039370, onClickListener).setNegativeButton(17039360, onClickListener).setOnDismissListener(onDismissListener).create();
        }
        this.mDialog.show();
