...
public interface IOPFaceSettingService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOPFaceSettingService {
        private static final String DESCRIPTOR = "com.oneplus.faceunlock.internal.IOPFaceSettingService";
        ...
        private static class Proxy implements IOPFaceSettingService {
            ...
            public int checkState(int userId) throws RemoteException {
            ...
            public void removeFace(int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public static IOPFaceSettingService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IOPFaceSettingService)) {
                return new Proxy(obj);
            }
            return (IOPFaceSettingService) iin;
        }
            ...
            if (code != 1598968902) {
                switch (code) {
                    case 1:
                        ...
                        int _result = checkState(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 2:
                        data.enforceInterface(descriptor);
                        removeFace(data.readInt());
                        reply.writeNoException();
                        return true;
                    default:
