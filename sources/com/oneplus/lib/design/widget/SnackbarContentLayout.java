...
import com.oneplus.lib.design.widget.BaseTransientBottomBar.ContentViewCallback;

@RestrictTo({Scope.LIBRARY_GROUP})
class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public void onFinishInflate() {
        ...
        this.mMessageView = (TextView) findViewById(R.id.op_snackbar_text);
        this.mActionView = (Button) findViewById(R.id.op_snackbar_action);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int multiLineVPadding = getResources().getDimensionPixelSize(R.dimen.op_design_snackbar_padding_vertical_2lines);
        int singleLineVPadding = getResources().getDimensionPixelSize(R.dimen.op_design_snackbar_padding_top);
