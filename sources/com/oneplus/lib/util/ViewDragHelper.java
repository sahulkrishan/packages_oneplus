...
public class ViewDragHelper {
     ...
     */
    public boolean canScroll(android.view.View r17, boolean r18, int r19, int r20, int r21, int r22) {
        /*
        r16 = this;
        r0 = r17;
    ...
    L_0x007f:
        return r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.util.ViewDragHelper.canScroll(android.view.View, boolean, int, int, int, int):boolean");
    }
    ...
    L_0x0168:
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.util.ViewDragHelper.shouldInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    L_0x0176:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.util.ViewDragHelper.processTouchEvent(android.view.MotionEvent):void");
    }
