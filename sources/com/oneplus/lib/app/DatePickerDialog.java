...
import com.oneplus.lib.widget.DatePicker.ValidationCallback;
import java.util.Calendar;

public class DatePickerDialog extends OPAlertDialog implements OnClickListener, OnDateChangedListener {
    ...
    private DatePickerDialog(Context context, int themeResId, OnDateSetListener listener, Calendar calendar, int year, int monthOfYear, int dayOfMonth) {
        ...
        View view = LayoutInflater.from(themeContext).inflate(R.layout.op_date_picker_dialog, null);
        setView(view);
