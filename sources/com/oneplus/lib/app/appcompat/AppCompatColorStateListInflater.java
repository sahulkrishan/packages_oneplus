...
final class AppCompatColorStateListInflater {
    ...
    L_0x0017:
        ...
        throw r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.app.appcompat.AppCompatColorStateListInflater.createFromXml(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.content.res.Resources$Theme):android.content.res.ColorStateList");
    }
    ...
    private static ColorStateList inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (type != 2 || depth > innerDepth) {
                ...
                i2 = innerDepth;
                i3 = defaultColor;
            } else if (parser.getName().equals(HitTypes.ITEM)) {
                TypedArray a = obtainAttributes(r, theme, attributeSet, R.styleable.OPColorStateListItem);
                int baseColor = a.getColor(R.styleable.OPColorStateListItem_android_color, -65281);
                float alphaMod = 1.0f;
                if (a.hasValue(R.styleable.OPColorStateListItem_android_alpha)) {
                    alphaMod = a.getFloat(R.styleable.OPColorStateListItem_android_alpha, 1.0f);
                } else if (a.hasValue(R.styleable.OPColorStateListItem_alpha)) {
                    alphaMod = a.getFloat(R.styleable.OPColorStateListItem_alpha, 1.0f);
                }
                a.recycle();
                ...
                while (i4 < i) {
                    ...
                    if (!(i == 16843173 || i == 16843551 || i == R.attr.alpha)) {
                        int j = innerDepth + 1;
                        if (attributeSet.getAttributeBooleanValue(i4, 0)) {
                            defaultColor = i;
                        } else {
                            defaultColor = -i;
                        }
                        stateSpec[innerDepth] = defaultColor;
                        innerDepth = j;
                    }
                    i4++;
                    i = numAttrs;
