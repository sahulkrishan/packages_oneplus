...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mContentHeight = a.getLayoutDimension(R.styleable.ActionMode_android_height, 0);
        this.mCloseItemLayout = a.getResourceId(R.styleable.ActionMode_closeItemLayout, R.layout.op_abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(R.layout.op_abc_action_bar_title_item, this);
