...
import com.oneplus.lib.app.appcompat.ActionBar.LayoutParams;
import com.oneplus.lib.app.appcompat.ActionBar.OnMenuVisibilityListener;
import com.oneplus.lib.app.appcompat.ActionBar.OnNavigationListener;
import com.oneplus.lib.app.appcompat.ActionBar.Tab;
...
import com.oneplus.lib.widget.actionbar.ToolbarWidgetWrapper;
...
class ToolbarActionBar extends ActionBar {
    ...
    /* JADX WARNING: Missing block: B:9:0x0027, code skipped:
            return null;
     */
    public android.view.View getListMenuView(android.view.Menu r3) {
        /*
        r2 = this;
        r2.ensureListMenuPresenter(r3);
        r0 = 0;
        if (r3 == 0) goto L_0x0027;
    L_0x0006:
        r1 = r2.mListMenuPresenter;
    ...
    L_0x0017:
        r0 = r2.mListMenuPresenter;
        r1 = r2.mDecorToolbar;
        r1 = r1.getViewGroup();
        r0 = r0.getMenuView(r1);
    ...
    L_0x0027:
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.app.appcompat.ToolbarActionBar.getListMenuView(android.view.Menu):android.view.View");
    }
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.applyStyle(R.style.OPTheme_AppCompat_CompactMenu, true);
            }
            context = new ContextThemeWrapper(context, 0);
            context.getTheme().setTo(widgetTheme);
            this.mListMenuPresenter = new ListMenuPresenter(context, R.layout.op_abc_list_menu_item_layout);
