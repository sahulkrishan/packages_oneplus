...
public class DrawableUtils {
    ...
    L_0x00a3:
        ...
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.app.appcompat.DrawableUtils.getOpticalBounds(android.graphics.drawable.Drawable):android.graphics.Rect");
    }
    ...
    public static boolean canSafelyMutateDrawable(@NonNull Drawable drawable) {
        ...
        Class dwClass = null;
        try {
            wdClass = Class.forName("android.support.v4.graphics.drawable.WrappedDrawable");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
        try {
            dwClass = Class.forName("android.support.v4.graphics.drawable.DrawableWrapper");
        ...
        } else if (drawable.getClass() == wdClass || drawable.getClass() == dwClass) {
            try {
                Method getWrappedDrawableMethod = (wdClass == null ? dwClass : wdClass).getMethod("getWrappedDrawable", new Class[0]);
                getWrappedDrawableMethod.setAccessible(true);
                return canSafelyMutateDrawable((Drawable) getWrappedDrawableMethod.invoke(drawable, new Object[0]));
            } catch (Exception e3) {
                e3.printStackTrace();
                return false;
            }
