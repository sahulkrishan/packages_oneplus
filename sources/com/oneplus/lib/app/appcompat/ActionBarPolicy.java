...
public class ActionBarPolicy {
    ...
    public int getMaxActionButtons() {
        ...
        if (res.getConfiguration().smallestScreenWidthDp > ConfigureWifiSettings.WIFI_WAKEUP_REQUEST_CODE || widthDp > ConfigureWifiSettings.WIFI_WAKEUP_REQUEST_CODE || ((widthDp > 960 && heightDp > 720) || (widthDp > 720 && heightDp > 960))) {
            return 5;
        }
    ...
    public boolean showsOverflowMenuButton() {
        ...
        return ViewConfigurationCompat.hasPermanentMenuKey(ViewConfiguration.get(this.mContext)) ^ 1;
    }
