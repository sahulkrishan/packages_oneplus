...
public class OPAlertDialog extends Dialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder setOnlyDarkTheme(boolean onlyDarkTheme) {
            this.P.mOnlyDarkTheme = onlyDarkTheme;
            return this;
        }

        public Builder setOnlyLightTheme(boolean onlyLightTheme) {
            this.P.mOnlyLightTheme = onlyLightTheme;
            return this;
        }
    ...
    public void setProgressStyle(int style) {
        this.mAlert.setProgressStyle(style);
    }
