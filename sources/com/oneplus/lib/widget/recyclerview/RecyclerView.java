...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class LayoutManager {
        ...
        public void dispatchStartTemporaryDetach(View view) {
            ...
            if (this.mDispatchStartTemporaryDetach != null) {
                try {
                    ...
                    Log.d(RecyclerView.TAG, "Error calling dispatchStartTemporaryDetach", e);
                    return;
                }
            }
        ...
        public void dispatchFinishTemporaryDetach(View view) {
            ...
            if (this.mDispatchFinishTemporaryDetach != null) {
                try {
                    ...
                    Log.d(RecyclerView.TAG, "Error calling dispatchFinishTemporaryDetach", e);
                    return;
                }
            }
        ...
        private void bindTempDetach() {
            try {
                ...
                Log.e(RecyclerView.TAG, "Couldn't find method", e);
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            properties.spanCount = a.getInt(R.styleable.RecyclerView_op_spanCount, 1);
            properties.reverseLayout = a.getBoolean(R.styleable.RecyclerView_op_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(R.styleable.RecyclerView_op_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    }
    ...
    public final class Recycler {
        ...
        public com.oneplus.lib.widget.recyclerview.RecyclerView.ViewHolder getScrapViewForPosition(int r8, int r9, boolean r10) {
            /*
            r7 = this;
        ...
        L_0x000a:
            ...
            r3 = r3.get(r2);
            r3 = (com.oneplus.lib.widget.recyclerview.RecyclerView.ViewHolder) r3;
        ...
        L_0x001e:
            ...
            if (r4 != 0) goto L_0x0073;
        L_0x0024:
            r4 = com.oneplus.lib.widget.recyclerview.RecyclerView.this;
            r4 = r4.mState;
            r4 = r4.mInPreLayout;
        ...
        L_0x003d:
            ...
            r5.append(r6);
            r5.append(r8);
            r6 = " isn't dirty but has wrong view type! (found ";
            r5.append(r6);
        ...
        L_0x0078:
            r2 = com.oneplus.lib.widget.recyclerview.RecyclerView.this;
            r2 = r2.mChildHelper;
            r2 = r2.findHiddenNonRemovedView(r8, r9);
            if (r2 == 0) goto L_0x008f;
        L_0x0082:
            r3 = com.oneplus.lib.widget.recyclerview.RecyclerView.this;
            r3 = r3.mItemAnimator;
            r4 = com.oneplus.lib.widget.recyclerview.RecyclerView.this;
        ...
        L_0x00b7:
            ...
            return r1;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.widget.recyclerview.RecyclerView$Recycler.getScrapViewForPosition(int, int, boolean):com.oneplus.lib.widget.recyclerview.RecyclerView$ViewHolder");
        }
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            r1 = com.oneplus.lib.widget.recyclerview.RecyclerView.this;
        ...
        L_0x001a:
            ...
            r10 = 0;
            r11 = 0;
            r12 = com.oneplus.lib.widget.recyclerview.RecyclerView.this;
            r12 = r12.mAdapter;
        ...
        L_0x004b:
            r12 = com.oneplus.lib.widget.recyclerview.RecyclerView.this;
            r12 = r12.mLayout;
            r13 = com.oneplus.lib.widget.recyclerview.RecyclerView.this;
            r13 = r13.mRecycler;
            r14 = com.oneplus.lib.widget.recyclerview.RecyclerView.this;
            r14 = r14.mState;
        ...
        L_0x008b:
            ...
            r15 = com.oneplus.lib.widget.recyclerview.RecyclerView.this;
            ...
            public void run() {
                if (RecyclerView.this.mFirstLayoutComplete) {
                    if (RecyclerView.this.mDataSetHasChangedAfterLayout) {
                        Trace.beginSection(RecyclerView.TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG);
                        RecyclerView.this.dispatchLayout();
                        Trace.endSection();
                    } else if (RecyclerView.this.mAdapterHelper.hasPendingUpdates()) {
                        Trace.beginSection(RecyclerView.TRACE_HANDLE_ADAPTER_UPDATES_TAG);
        ...
        if (dispatchOnItemTouchIntercept(e)) {
            ...
            switch (action) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    x = motionEvent.findPointerIndex(this.mScrollPointerId);
                    if (x >= 0) {
                        int x2 = (int) (motionEvent.getX(x) + 1056964608);
                        y = (int) (motionEvent.getY(x) + 0.5f);
            ...
            switch (action) {
                ...
                case 2:
                    ...
                    if (index >= 0) {
                        int i;
                        int i2;
                        int x2 = (int) (motionEvent.getX(index) + 1056964608);
