...
class NestedScrollingChildHelper {
    ...
    public boolean startNestedScroll(int axes) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            for (ViewParent p = this.mView.getParent(); p != null; p = p.getParent()) {
                if (p.onStartNestedScroll(child, this.mView, axes)) {
                    this.mNestedScrollingParent = p;
                    p.onNestedScrollAccepted(child, this.mView, axes);
                    return true;
                }
    ...
    public boolean dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int[] offsetInWindow) {
        if (isNestedScrollingEnabled() && this.mNestedScrollingParent != null) {
            if (dxConsumed != 0 || dyConsumed != 0 || dxUnconsumed != 0 || dyUnconsumed != 0) {
                ...
                this.mNestedScrollingParent.onNestedScroll(this.mView, dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed);
                if (offsetInWindow != null) {
                    this.mView.getLocationInWindow(offsetInWindow);
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, int[] consumed, int[] offsetInWindow) {
        if (isNestedScrollingEnabled() && this.mNestedScrollingParent != null) {
            ...
            if (dx != 0 || dy != 0) {
                ...
                consumed[0] = 0;
                consumed[1] = 0;
                this.mNestedScrollingParent.onNestedPreScroll(this.mView, dx, dy, consumed);
                if (offsetInWindow != null) {
                    this.mView.getLocationInWindow(offsetInWindow);
                    offsetInWindow[0] = offsetInWindow[0] - startX;
                    offsetInWindow[1] = offsetInWindow[1] - startY;
    ...
    public boolean dispatchNestedFling(float velocityX, float velocityY, boolean consumed) {
        ...
        return this.mNestedScrollingParent.onNestedFling(this.mView, velocityX, velocityY, consumed);
    }
    ...
    public boolean dispatchNestedPreFling(float velocityX, float velocityY) {
        ...
        return this.mNestedScrollingParent.onNestedPreFling(this.mView, velocityX, velocityY);
    }
