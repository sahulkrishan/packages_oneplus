...
import com.oneplus.lib.menu.ActionMenuItem;
...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
        this(toolbar, style, 0, R.drawable.abc_ic_ab_back_material);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        if (style) {
            ...
            setDisplayOptions(a.getInt(R.styleable.ActionBar_op_displayOptions, 0));
            ...
            int popupTheme = a.getResourceId(R.styleable.ActionBar_android_popupTheme, 0);
            if (popupTheme != 0) {
