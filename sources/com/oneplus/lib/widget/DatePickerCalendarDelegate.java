...
class DatePickerCalendarDelegate extends AbstractDatePickerDelegate {
    ...
    private void tryVibrate() {
        ...
        try {
            Field effectClick = VibrationEffect.class.getDeclaredField("EFFECT_CLICK");
            Method getMethod = VibrationEffect.class.getDeclaredMethod("get", new Class[]{Integer.TYPE});
            getMethod.setAccessible(true);
            effectClick.setAccessible(true);
            ((Vibrator) this.mContext.getSystemService("vibrator")).vibrate((VibrationEffect) getMethod.invoke(null, new Object[]{Integer.valueOf(effectClick.getInt(null))}), VIBRATION_ATTRIBUTES);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
