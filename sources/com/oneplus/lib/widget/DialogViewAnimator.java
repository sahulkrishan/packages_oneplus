...
public class DialogViewAnimator extends ViewAnimator {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean z = (MeasureSpec.getMode(widthMeasureSpec) == Ints.MAX_POWER_OF_TWO && MeasureSpec.getMode(heightMeasureSpec) == Ints.MAX_POWER_OF_TWO) ? false : true;
        ...
        while (true) {
            ...
            if (getMeasureAllChildren() || child.getVisibility() != 8) {
                ...
                if (measureMatchParentChildren && !matchWidth) {
                    ...
                    i4 = 0 | (child2.getMeasuredWidthAndState() & ViewCompat.MEASURED_STATE_MASK);
                }
                if (measureMatchParentChildren && !matchHeight) {
                    ...
                    i4 |= (child2.getMeasuredHeightAndState() >> 16) & InputDeviceCompat.SOURCE_ANY;
                }
        ...
        while (true) {
            ...
            if (childState2 < i) {
                ...
                if (lp3.width == i4) {
                    maxWidth = MeasureSpec.makeMeasureSpec((((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - lp3.leftMargin) - lp3.rightMargin, Ints.MAX_POWER_OF_TWO);
                } else {
                    maxWidth = getChildMeasureSpec(i2, ((getPaddingLeft() + getPaddingRight()) + lp3.leftMargin) + lp3.rightMargin, lp3.width);
                }
                if (lp3.height == i4) {
                    maxHeight = MeasureSpec.makeMeasureSpec((((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom()) - lp3.topMargin) - lp3.bottomMargin, Ints.MAX_POWER_OF_TWO);
                } else {
