...
public class RadialTimePickerView extends View {
    ...
    private static final int MAX_SECOND_MINUTES_SHOWING_TIMES = 1;
    ...
    private static final int SECOND_MINUTES_NUMBERS_RANGE = 4;
    ...
    private int mSecondMinutesShowTimes;
    ...
    private class RadialPickerTouchHelper extends ExploreByTouchHelper {
        ...
        public void onPopulateNodeForVirtualView(int virtualViewId, AccessibilityNodeInfo node) {
            ...
            if (nextId != Integer.MIN_VALUE && VERSION.SDK_INT >= 22) {
    ...
    public void applyAttributes(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        ColorStateList numbersTextColor = a.getColorStateList(R.styleable.TimePicker_numbersTextColor);
        ColorStateList numbersInnerTextColor = a.getColorStateList(R.styleable.TimePicker_numbersInnerTextColor);
        ...
        ColorStateList selectorColors = a.getColorStateList(R.styleable.TimePicker_android_numbersSelectorColor);
        if (selectorColors != null) {
            selectorActivatedColor = selectorColors.getColorForState(ViewUtils.getViewState(40), 0);
        }
        this.mPaintCenter.setColor(selectorActivatedColor);
        int[] stateSetActivated = ViewUtils.getViewState(40);
        this.mSelectorColor = selectorActivatedColor;
        this.mSelectorDotColor = this.mTextColor[0].getColorForState(stateSetActivated, 0);
        this.mPaintBackground.setColor(a.getColor(R.styleable.TimePicker_android_numbersBackgroundColor, context.getResources().getColor(R.color.timepicker_default_numbers_background_color_material)));
        a.recycle();
    }
    ...
    private void animatePicker(boolean hoursToMinutes, long duration) {
        ...
        this.mHoursToMinutesAnimator = ObjectAnimator.ofFloat(this, "HoursToMinutes", new float[]{this.mHoursToMinutes, hoursToMinutes ? 0.0f : 1.0f});
    ...
    public void setHoursToMinutes(float value) {
        this.mHoursToMinutes = value;
        invalidate();
    }
    ...
    private void drawSelector(Canvas canvas, Path selectorPath) {
        ...
        float selCenterX = (((float) Math.sin(selAngleRad)) * selLength) + ((float) this.mXCenter);
        ...
        if (dotScale > 0.0f) {
            dotPaint = this.mPaintSelector[1];
        ...
        minutesDotScale = selLength - ((float) selRadius);
        int selRadius2 = selRadius;
        float linePointX = (float) ((this.mXCenter + ((int) (((double) this.mCenterDotRadius) * sin))) + ((int) (((double) minutesDotScale) * sin)));
        float linePointY = (float) ((this.mYCenter - ((int) (((double) this.mCenterDotRadius) * cos))) - ((int) (((double) minutesDotScale) * cos)));
        dotPaint = this.mPaintSelector[2];
        dotPaint.setColor(this.mSelectorColor);
        dotPaint.setStrokeWidth((float) this.mSelectorStroke);
        ...
        linePaint2.setColor(-7829368);
        Paint linePaint3 = linePaint2;
        this.oval.set(this.mOuterTextX[1][9], this.mOuterTextX[1][0], this.mOuterTextX[1][3], this.mOuterTextX[1][6]);
        canvas2.drawArc(this.oval, (float) (getDegreesForMinute(getCurrentMinute()) - 45), 90.0f, true, linePaint3);
    }
    ...
    private void drawTextElements(Canvas canvas, float textSize, Typeface typeface, ColorStateList textColor, String[] texts, float[] textX, float[] textY, Paint paint, int alpha, boolean showActivated, int activatedDegrees, boolean activatedOnly) {
        ...
        while (i3 < i2) {
            ...
            if (!activatedOnly || activated) {
                ...
                i4 = textColor.getColorForState(ViewUtils.getViewState(8 | i4), z);
                paint2.setColor(i4);
    ...
    private boolean handleTouchInput(float x, float y, boolean forceSelection, boolean autoAdvance) {
        ...
        if (valueChanged || forceSelection) {
            if (!OPFeaturesUtils.isSupportXVibrate()) {
                ...
                this.mVibratePattern = VibratorSceneUtils.getVibratorScenePattern(getContext(), this.mVibrator, VibratorSceneUtils.VIBRATOR_SCENE_CLOCK_MINUTE);
    ...
    public PointerIcon onResolvePointerIcon(MotionEvent event, int pointerIndex) {
        ...
        if (getDegreesFromXY(event.getX(), event.getY(), false) == -1 || VERSION.SDK_INT < 24) {
