...
class TimePickerSpinnerDelegate extends AbstractTimePickerDelegate {
    ...
    public TimePickerSpinnerDelegate(TimePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int layoutResourceId = a.getResourceId(R.styleable.TimePicker_legacyLayout, R.layout.op_time_picker_legacy_material);
        a.recycle();
        ...
        if (isAmPmAtStart()) {
            ViewGroup amPmParent = (ViewGroup) timePicker.findViewById(R.id.timePickerLayout);
