...
abstract class GenericInflater<T, P extends Parent> {
    ...
    public T inflate(org.xmlpull.v1.XmlPullParser r8, P r9, boolean r10) {
        ...
        monitor-enter(r0);
        r1 = android.util.Xml.asAttributeSet(r8);	 Catch:{ all -> 0x0084 }
        r2 = r7.mConstructorArgs;	 Catch:{ all -> 0x0084 }
        r3 = 0;
        r4 = r7.mContext;	 Catch:{ all -> 0x0084 }
        r2[r3] = r4;	 Catch:{ all -> 0x0084 }
        r2 = r9;
    L_0x000f:
        r3 = r8.next();	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r4 = r3;
        r5 = 2;
    ...
    L_0x001d:
        r3 = r8.getName();	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r3 = r7.createItemFromTag(r8, r3, r1);	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r5 = r3;
        r5 = (com.oneplus.lib.preference.GenericInflater.Parent) r5;	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r5 = r7.onMergeRoots(r9, r10, r5);	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r2 = r5;
        ...
        return r2;
    L_0x0033:
        r3 = new android.view.InflateException;	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r5 = new java.lang.StringBuilder;	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r5.<init>();	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r6 = r8.getPositionDescription();	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r5.append(r6);	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r6 = ": No start tag found!";
        r5.append(r6);	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r5 = r5.toString();	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        r3.<init>(r5);	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
        throw r3;	 Catch:{ InflateException -> 0x0082, XmlPullParserException -> 0x0074, IOException -> 0x004e }
    L_0x004e:
        r3 = move-exception;
        r4 = new android.view.InflateException;	 Catch:{ all -> 0x0084 }
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0084 }
        r5.<init>();	 Catch:{ all -> 0x0084 }
        r6 = r8.getPositionDescription();	 Catch:{ all -> 0x0084 }
        r5.append(r6);	 Catch:{ all -> 0x0084 }
        r6 = ": ";
        r5.append(r6);	 Catch:{ all -> 0x0084 }
        r6 = r3.getMessage();	 Catch:{ all -> 0x0084 }
        r5.append(r6);	 Catch:{ all -> 0x0084 }
    ...
    L_0x0074:
        r3 = move-exception;
        r4 = new android.view.InflateException;	 Catch:{ all -> 0x0084 }
        r5 = r3.getMessage();	 Catch:{ all -> 0x0084 }
        r4.<init>(r5);	 Catch:{ all -> 0x0084 }
        r4.initCause(r3);	 Catch:{ all -> 0x0084 }
        throw r4;	 Catch:{ all -> 0x0084 }
    L_0x0082:
    ...
    L_0x0084:
        ...
        throw r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.preference.GenericInflater.inflate(org.xmlpull.v1.XmlPullParser, com.oneplus.lib.preference.GenericInflater$Parent, boolean):java.lang.Object");
    }
