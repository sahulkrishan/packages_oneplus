...
public class MultiSelectListPreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat {
    ...
    static /* synthetic */ boolean access$076(MultiSelectListPreferenceDialogFragmentCompat x0, int x1) {
        byte b = (byte) (x0.mPreferenceChanged | x1);
        x0.mPreferenceChanged = b;
        return b;
    }
    ...
    public void onPrepareDialogBuilder(Builder builder) {
        ...
        builder.setMultiChoiceItems(this.mEntries, checkedItems, new OnMultiChoiceClickListener() {
            public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                if (isChecked) {
                    MultiSelectListPreferenceDialogFragmentCompat.access$076(MultiSelectListPreferenceDialogFragmentCompat.this, MultiSelectListPreferenceDialogFragmentCompat.this.mNewValues.add(MultiSelectListPreferenceDialogFragmentCompat.this.mEntryValues[which].toString()));
                } else {
                    MultiSelectListPreferenceDialogFragmentCompat.access$076(MultiSelectListPreferenceDialogFragmentCompat.this, MultiSelectListPreferenceDialogFragmentCompat.this.mNewValues.remove(MultiSelectListPreferenceDialogFragmentCompat.this.mEntryValues[which].toString()));
                }
            }
        });
    }
