...
public class PlaybackFragment extends Fragment {
    ...
    final Client mChainedClient = new Client() {
        public boolean isSeekEnabled() {
            return PlaybackFragment.this.mSeekUiClient == null ? false : PlaybackFragment.this.mSeekUiClient.isSeekEnabled();
        }
        ...
        public PlaybackSeekDataProvider getPlaybackSeekDataProvider() {
            return PlaybackFragment.this.mSeekUiClient == null ? null : PlaybackFragment.this.mSeekUiClient.getPlaybackSeekDataProvider();
        }
    ...
    private class SetSelectionRunnable implements Runnable {
        ...
        /* synthetic */ SetSelectionRunnable(PlaybackFragment x0, AnonymousClass1 x1) {
            this();
        }
        ...
        AnimatorUpdateListener updateListener = new AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator arg0) {
                if (PlaybackFragment.this.getVerticalGridView() != null) {
                    RecyclerView.ViewHolder vh = PlaybackFragment.this.getVerticalGridView().findViewHolderForAdapterPosition(0);
                    if (vh != null) {
