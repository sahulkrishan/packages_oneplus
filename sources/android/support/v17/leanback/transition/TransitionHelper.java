...
public final class TransitionHelper {
    ...
    public static void addTransitionListener(Object transition, final TransitionListener listener) {
        if (listener != null) {
            if (VERSION.SDK_INT >= 19) {
                ...
                listener.mImpl = new TransitionListener() {
                ...
                t.addListener((TransitionListener) listener.mImpl);
            } else {
    ...
    public static void removeTransitionListener(Object transition, TransitionListener listener) {
        if (VERSION.SDK_INT < 19) {
            ...
            ((Transition) transition).removeListener((TransitionListener) listener.mImpl);
            listener.mImpl = null;
        }
    }
    ...
    public static void runTransition(Object scene, Object transition) {
        ...
        if (!(transitionStub == null || transitionStub.mTransitionListeners == null)) {
            size = transitionStub.mTransitionListeners.size();
        ...
        if (transitionStub != null && transitionStub.mTransitionListeners != null) {
            ...
            for (size = 0; size < size2; size++) {
                ((TransitionListener) transitionStub.mTransitionListeners.get(size)).onTransitionEnd(transition);
            }
        }
    }
    ...
    public static void setEpicenterCallback(Object transition, final TransitionEpicenterCallback callback) {
        ...
        if (callback == null) {
            ...
            ((Transition) transition).setEpicenterCallback(new EpicenterCallback() {
