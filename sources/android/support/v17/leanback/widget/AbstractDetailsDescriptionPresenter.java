...
public abstract class AbstractDetailsDescriptionPresenter extends Presenter {
    ...
    public static class ViewHolder extends android.support.v17.leanback.widget.Presenter.ViewHolder {
        ...
        final FontMetricsInt mBodyFontMetricsInt = getFontMetricsInt(this.mBody);
        final int mBodyLineSpacing;
        final int mBodyMaxLines;
        final int mBodyMinLines;
        private OnPreDrawListener mPreDrawListener;
        final TextView mSubtitle;
        final FontMetricsInt mSubtitleFontMetricsInt = getFontMetricsInt(this.mSubtitle);
        final TextView mTitle;
        final FontMetricsInt mTitleFontMetricsInt = getFontMetricsInt(this.mTitle);
        ...
        public ViewHolder(View view) {
            ...
            FontMetricsInt titleFontMetricsInt = getFontMetricsInt(this.mTitle);
            this.mTitleMargin = titleFontMetricsInt.ascent + view.getResources().getDimensionPixelSize(R.dimen.lb_details_description_title_baseline);
            ...
            this.mTitle.addOnLayoutChangeListener(new OnLayoutChangeListener() {
                ...
                this.mPreDrawListener = new OnPreDrawListener() {
                    public boolean onPreDraw() {
                        if (ViewHolder.this.mSubtitle.getVisibility() != 0 || ViewHolder.this.mSubtitle.getTop() <= ViewHolder.this.view.getHeight() || ViewHolder.this.mTitle.getLineCount() <= 1) {
                            int maxLines = ViewHolder.this.mTitle.getLineCount() > 1 ? ViewHolder.this.mBodyMinLines : ViewHolder.this.mBodyMaxLines;
