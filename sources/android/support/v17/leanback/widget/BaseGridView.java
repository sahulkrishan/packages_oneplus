...
public abstract class BaseGridView extends RecyclerView {
        ...
        if (task != null) {
            ...
            if (vh == null || hasPendingAdapterUpdates()) {
                addOnChildViewHolderSelectedListener(new OnChildViewHolderSelectedListener() {
                    public void onChildViewHolderSelected(RecyclerView parent, ViewHolder child, int selectedPosition, int subposition) {
    ...
    public void setSelectedPosition(final int position, final ViewHolderTask task) {
        if (task != null) {
            ...
            if (vh == null || hasPendingAdapterUpdates()) {
                addOnChildViewHolderSelectedListener(new OnChildViewHolderSelectedListener() {
                    public void onChildViewHolderSelectedAndPositioned(RecyclerView parent, ViewHolder child, int selectedPosition, int subposition) {
                        if (selectedPosition == position) {
                            BaseGridView.this.removeOnChildViewHolderSelectedListener(this);
                            task.run(child);
                        }
