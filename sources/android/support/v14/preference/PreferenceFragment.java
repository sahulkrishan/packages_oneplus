...
public abstract class PreferenceFragment extends Fragment implements OnPreferenceTreeClickListener, OnDisplayPreferenceDialogListener, OnNavigateToScreenListener, TargetFragment {
    ...
    private class DividerDecoration extends ItemDecoration {
        ...
        /* synthetic */ DividerDecoration(PreferenceFragment x0, AnonymousClass1 x1) {
            this();
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        TypedArray a = this.mStyledContext.obtainStyledAttributes(null, android.support.v7.preference.R.styleable.PreferenceFragment, TypedArrayUtils.getAttr(this.mStyledContext, R.attr.preferenceFragmentStyle, AndroidResources.ANDROID_R_PREFERENCE_FRAGMENT_STYLE), 0);
        this.mLayoutResId = a.getResourceId(0, this.mLayoutResId);
        Drawable divider = a.getDrawable(1);
        int dividerHeight = a.getDimensionPixelSize(2, -1);
        boolean allowDividerAfterLastItem = a.getBoolean(true, true);
        a.recycle();
        TypedValue tv = new TypedValue();
        getActivity().getTheme().resolveAttribute(R.attr.preferenceTheme, tv, true);
        int theme = tv.resourceId;
