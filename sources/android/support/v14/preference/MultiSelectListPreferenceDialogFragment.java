...
public class MultiSelectListPreferenceDialogFragment extends PreferenceDialogFragment {
    ...
    static /* synthetic */ boolean access$076(MultiSelectListPreferenceDialogFragment x0, int x1) {
    ...
    public void onPrepareDialogBuilder(Builder builder) {
        ...
        builder.setMultiChoiceItems(this.mEntries, checkedItems, new OnMultiChoiceClickListener() {
            public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                if (isChecked) {
                    MultiSelectListPreferenceDialogFragment.access$076(MultiSelectListPreferenceDialogFragment.this, MultiSelectListPreferenceDialogFragment.this.mNewValues.add(MultiSelectListPreferenceDialogFragment.this.mEntryValues[which].toString()));
                } else {
                    MultiSelectListPreferenceDialogFragment.access$076(MultiSelectListPreferenceDialogFragment.this, MultiSelectListPreferenceDialogFragment.this.mNewValues.remove(MultiSelectListPreferenceDialogFragment.this.mEntryValues[which].toString()));
                }
            }
        });
    }
