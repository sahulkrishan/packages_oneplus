...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        float tensionSlingshotPercent = Math.max(0.0f, Math.min(extraOS, slingshotDist2 * DECELERATE_INTERPOLATION_FACTOR) / slingshotDist2);
        ...
        int targetY = this.mOriginalOffsetTop + ((int) ((slingshotDist2 * dragPercent) + ((slingshotDist2 * tensionPercent) * DECELERATE_INTERPOLATION_FACTOR)));
